...
<CardGroup cols={2}>
  <Card title="Get Started" href="/docs/integration-tweezer" icon="arrow-up-right" />
  <Card title="Transaction Methods" href="/docs/transaction-methods" icon="arrow-up-right" />
</CardGroup>
