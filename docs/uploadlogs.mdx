...
All methods in TweezerComm follow a JSON-RPC 2.0 structure. See [Get Started](doc:integration-1)for more details on how the requests are structured and sent.
</Note>
