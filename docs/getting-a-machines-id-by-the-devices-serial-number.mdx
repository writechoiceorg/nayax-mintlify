...
To retrieve a machine's ID using its serial number, you need to use the [Get All Machines](/reference/get-all-machine-basic-info) endpoint. By providing the device's serial number in the request you can retrieve the corresponding machine's unique identifier.
