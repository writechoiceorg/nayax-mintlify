...
<CardGroup cols={2}>
  <Card title="C# & Java SDK Integration" href="/v1.0/docs/marshall-csharp-java-integration" icon="arrow-up-right" />
  <Card title="C SDK Integration" href="/v1.0/docs/c-sdk-integration" icon="arrow-up-right" />
</CardGroup>
