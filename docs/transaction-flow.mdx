...
<CardGroup cols={3}>
  <Card title="Payment with Pre-Authorization" href="/docs/payment-with-authorization" icon="arrow-up-right">
  ...
  <Card title="Closed Loop Transaction" href="/docs/closed-loop-transaction" icon="arrow-up-right">
  ...
  <Card title="Single Step Payment" href="/docs/single-step-payment" icon="arrow-up-right">
