...
Use the [Upload Refund Documentation](/reference/upload-refund-documentation) endpoint to upload the file received by the billing provider. See the request example below:
