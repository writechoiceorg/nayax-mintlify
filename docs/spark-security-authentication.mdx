...
1. Prepare the JSON body with all the necessary fields (e.g., `TerminalId`, `Cipher`, etc.). Here’s a simplified example for the [StartAuthentication](ref:post_startauthentication) endpoint:
...
2. Serialize the JSON request content, removing whitespace and line breaks. Do not alter values or add escape characters unless they are part of the actual payload.
   ...
   <Image align="center" border={false} src="https://files.readme.io/961ba921dc161fe1f546ad758cb901af67990498b5adf51ea3e3e14cca98368d-image.png" />
...
3. Generate the `Signature` header following the steps below:
   ...
   2. Hash the result using SHA-256 (UTF-8 encoded):
      ...
      <Image border={false} src="https://files.readme.io/94a7e95371f859f4974b30e2ec25ba128e27e85ae0ec1655fe45998acd40089e-image.png" />
...
For this example, the [`/StartAuthentication`](ref:post_startauthentication)  method was used, but the process is relevant for any Spark endpoint request and response.
...
<CardGroup cols={2}>
  ...
  <Card title="API Methods" href="/v1.0/docs/api-methods-spark" icon="arrow-up-right" />
</CardGroup>