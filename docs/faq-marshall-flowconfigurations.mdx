...
Should you need a longer lap than that, you can use [Multi-Session](https://developerhub.nayax.com/docs/marshall-multi-session#/), in which the timeout for credit cards are 23 hours (<ins>can be up to 72 hours as of 2025</ins>), and for proprietary cards it's 72 hours.
