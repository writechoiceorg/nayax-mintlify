...
The Marshall Pro (Fuel) integrates into a complex ecosystem involving local hardware, forecourt controllers, and multiple backend authorization engines.

![Forecourt Architecture](/images/forecourt.png)

### The Forecourt (On-Site)
The forecourt consists of the physical hardware interacting with customers and fuel dispensers.

<CardGroup cols={2}>
  <Card icon="link" title="Pay-at-the-Pump Terminal" icon="gas-pump">
  ...
  <Card icon="link" title="Forecourt Controller (FCC)" icon="network-wired">
  ...
  <Card title="Point of Sale (POS)" icon="cash-register">
     The system managing the c-store in forecourt environment.
  </Card>
  <Card icon="link" title="Back-office" icon="gears">
