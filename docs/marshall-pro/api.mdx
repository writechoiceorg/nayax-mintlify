...
<CardGroup cols={2}>
  <Card icon="link" title="Payment Processing" icon="credit-card">
   Supports single-phase (`pay`) and two-phase (`authorize` + `settle`) fuel transactions.
  </Card>
  <Card icon="link" title="Card Detection" icon="magnifying-glass">
   Read card data without an immediate charge—perfect for Loyalty and Customer ID.
  </Card>
  <Card icon="link" title="User Interface" icon="desktop">
   Take control of the terminal screen to show custom menus, fuel types, or prompts.
  </Card>
  <Card icon="link" title="Peripheral Support" icon="print">
   Directly trigger the integrated thermal printer for customer receipts.
  </Card>
</CardGroup>

See [Request and Response Format](/docs/marshall-pro/request-response-format) for more information.
