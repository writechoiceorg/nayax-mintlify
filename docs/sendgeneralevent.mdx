...
All methods in TweezerComm follow a JSON-RPC 2.0 structure. See [Get Started](https://developerhub.nayax.com/docs/tweezercomm-get-started) for more details on how the requests are structured and sent.
</Note>
