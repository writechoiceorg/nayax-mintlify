...
metadata:
  og:description: "This page shows you how to update product prices through DEX or send a DEX file to a machine using the Lynx API. In the step-by-step guide below."
---
