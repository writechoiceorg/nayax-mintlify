...
The V1 option requires only the essential fields for basic card creation, with minimal optional fields. To create the card, send a **POST** request to the [Create Virtual Card](/reference/lynx/cards/create-virtual-card) endpoint, filling in the card details in the body parameters. See the example in the code block below:
