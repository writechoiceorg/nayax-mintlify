...
metadata:
  og:description: "The Lynx API provides several GET methods to retrieve detailed information about cards. These allow you to query card details, check credit balances."
---
...
<Columns cols={2}>
  <Card icon="link" title="Get Cards" href="/reference/lynx/cards/get-cards" />

  <Card icon="link" title="Get Card by the Card's Display Number" href="/reference/lynx/cards/get-card-by-the-cards-display-number" />

  <Card icon="link" title="Get Prepaid Card" href="/reference/lynx/cards/get-prepaid-card" />

  <Card icon="link" title="Get the Credit from a Card" href="/reference/lynx/cards/get-the-credit-from-a-card" />

  <Card icon="link" title="Get Card's Revalue" href="/reference/lynx/cards/get-cards-revalue" />
</Columns>
...
Refer to the [Security & Token](/docs/manage-data-operations/lynx-api/security) page of this documentation to learn how to access your tokens, and how to use them to authenticate your API requests properly.
</Warning>
