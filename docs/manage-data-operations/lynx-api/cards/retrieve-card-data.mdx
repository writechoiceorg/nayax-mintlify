...
<Columns cols={2}>
  ...
  <Card icon="link" title="Get the Credit from a Card" href="/reference/lynx/cards/get-card-credit" />

  <Card icon="link" title="Get Card's Revalue" href="/reference/lynx/cards/get-card-revalue" />
</Columns>
