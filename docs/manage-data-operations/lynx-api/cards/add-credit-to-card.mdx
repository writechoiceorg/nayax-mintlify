...
metadata:
  og:description: "This guide will walk you through adding credit to a card using the Lynx API. At the end, you’ll learn how to verify these changes in Nayax Core."
---
...
<EndpointCard
  ...
  href="/reference/lynx/cards/add-card-credit"
  method="post"
/>
...
To add credit to a card you can use the **POST** method on the [Add Credit to a Card](/reference/lynx/cards/add-card-credit) endpoint. Sending the card's Unique Identifier in the URL. See the example query below:
