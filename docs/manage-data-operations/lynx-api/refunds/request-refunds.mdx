...
To start the request, use the [Request a Payment Refund](/reference/lynx/payment/request-payment-refund)  endpoint to request a refund. Providing the attributes regarding the refund in the body parameters of the request, as exemplified below:
