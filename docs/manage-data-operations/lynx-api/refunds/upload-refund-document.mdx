...
`POST /v1/payment/upload-refund` requires a role with financial permissions. A standard operator token returns `403 Insufficient Permissions`. Contact your Nayax account manager to enable refund permissions for your account.
</Warning>
