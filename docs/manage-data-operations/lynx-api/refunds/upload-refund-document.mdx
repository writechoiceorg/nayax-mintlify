...
| FileData      | base64    | The base64-encoded content of the file being uploaded. You can use a [PDF to base64 online converter](https://base64.guru/converter/encode/pdf). |
