...
When a refund is successfully requested, the transaction remains in the **Pending** status until you approve or decline it. You can see this in Nayax core by going to **Reports > Online Reports > Dynamic Transactions Monitor**. Follow the steps below:
