...
To decline a refund, use the [Decline a Payment Refund](/reference/lynx/payment/decline-payment-refund) endpoint. The code block below displays the request object and its body parameters.
