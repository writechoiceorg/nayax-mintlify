...
After you successfully request a refund, the transaction remains in **Pending** status until you approve or decline it. You can see this in Nayax core by going to **Reports > Online Reports > Dynamic Transactions Monitor**. Follow the steps below:
