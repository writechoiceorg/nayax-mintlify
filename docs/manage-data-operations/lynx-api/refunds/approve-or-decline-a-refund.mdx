...
metadata:
  og:description: "When a refund is successfully requested, the transaction will remain in the Pending status until approved or declined. You can see this in Nayax core."
---
...
Once the request is approved or declined, the consumer will receive an email at the address provided in the refund request. The request status will also be updated. You can see this in Nayax core by going to **Reports > Online Reports > Dynamic Transactions Monitor**.
