...
metadata:
  og:description: "Nayax Core shows an operator's hierarchy in the Operator menu on the left sidebar. If you check its data, the Company section will detail its."
---
