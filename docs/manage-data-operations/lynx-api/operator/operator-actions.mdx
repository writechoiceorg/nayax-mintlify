...
In Nayax Core, you can perform various actions on Operators, such as updating or retrieving operator information. All of these are performed in the **Administration > Operators** menu.
