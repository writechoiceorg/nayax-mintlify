...
metadata:
  og:description: "Nayax uses a structured system to organize and manage entities, reflecting real-world business operations. This hierarchy is foundational for."
---
...
The diagram below illustrates the hierarchy within Nayax, showing how Nayax organizes entities from the top level (Distributor) down to the lowest level (Machines).
