...
<EndpointCard
  ...
  href="/reference/lynx/actors/create-a-new-actor"
  method="post"
/>
...
The [Create New Actor ](/reference/lynx/actors/create-a-new-actor)endpoint allows for registering a new operator in the Nayax system. See the example request in the code block below:
