...
You need an access token to interact securely with the Lynx API. This guide provides an overview of generating and using access tokens and best practices for ensuring API security.
...
Do not share your secret tokens in public places like Github or Bitbucket since it can allow malicious API calls.
</Warning>
