...
metadata:
  og:description: "Products in Nayax represent the items or services operators offer, such as snacks, beverages, or digital products. Each product is uniquely."
---
...
You can add a new product to an operator's catalog using the [Create New Operator Product ](/reference/lynx/products/create-new-operator-product) endpoint. See an example request in the code block below:
