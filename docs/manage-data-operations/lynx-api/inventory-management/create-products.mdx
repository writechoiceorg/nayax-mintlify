...
You can add a new product to an operator's catalog using the [Create New Operator Product ](/reference/lynx/products/create-operator-product) endpoint. See an example request in the code block below:
