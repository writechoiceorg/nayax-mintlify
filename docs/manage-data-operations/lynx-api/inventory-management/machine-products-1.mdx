...
The [Create Machine Products](/reference/lynx/machine-products/create-machine-products) endpoint allows you to create the product map for a machine and add products to it by providing the `MachineID` in the path param of the request. See the example request in the code block below:
