...
<Note>
  Every widget has its own unique identifier (`widget_type_id`), filters, and other configuration options. See a list of all [Widgets ID List](/docs/manage-data-operations/lynx-api/reports/available-widgets).
</Note>
...
The **Sales By Period** widget shows a bar chart showing revenue generated across your fleet or a specific set of machines. It helps you identify sales trends, peak performance days, and transaction volume at a glance.
...
The **Dashboard Sales Table** provides a detailed numeric breakdown of performance by period. It helps you see exact revenue and vend counts for specific timeframes at a glance.
...
The **Last Year vs This Year Monthly Sales** widget provides a high-level visual comparison of sales performance across two years. It helps you track long-term business growth and seasonal trends.
...
The **10 Most Popular Machines Sales/Vends** widget provides a ranking of the top-performing machines in your fleet. This helps you quickly identify high-traffic locations and the most profitable units based on their sales volume.
