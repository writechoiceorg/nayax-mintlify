...
<Columns cols={3}>
  <Card icon="link" title="List Widgets for a Screen" href="/reference/lynx/report/get-available-widgets">
    Returns all widgets configured for a given screen type, including their IDs, names, and configurations.
  </Card>

  <Card icon="link" title="Retrieve Widget Data (POST)" href="/reference/lynx/report/retrieve-widget-data">
