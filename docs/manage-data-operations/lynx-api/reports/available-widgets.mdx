...
metadata:
  og:description: "The Widget Type ID is a unique numeric identifier for each widget. It is the primary key required for all API data requests as the widgettypeid."
---
...
<Accordion title="Operator/Actor Level (Multi-Machine Data)">
  ...
  | `19`  | [Sales By Period](/docs/manage-data-operations/lynx-api/reports/widgets-lynx) |
  | `20`  | Machines On Map                                  |
