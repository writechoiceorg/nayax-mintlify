...
<Accordion title="Operator/Actor Level (Multi-Machine Data)">
  ...
  | `3`   | [Last Year vs This Year Monthly Sales](/docs/widgets-lynx) |
  | `5`   | Top Events For Period                            |
  | `6`   | KeepAlives For Period                            |
  | `19`  | [Sales By Period](/docs/widgets-lynx) |
  | `20`  | Machines On Map                                  |
  | `22`  | [(Operator) 10 Most Popular Machines Sales/Vends](/docs/widgets-lynx)  |
  ...
  | `53`  | [Dashboard Sales Table](/docs/widgets-lynx)                             |
  | `244` | Machines Alert                                   |
