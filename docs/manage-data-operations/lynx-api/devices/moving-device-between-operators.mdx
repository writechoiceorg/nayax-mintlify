...
As you can see, the body of the request above contains two serial numbers for devices to move to the target operator. The response will return the status of each device moved. See the code block below:
