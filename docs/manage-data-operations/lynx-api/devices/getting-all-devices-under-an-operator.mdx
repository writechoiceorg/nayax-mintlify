...
metadata:
  og:description: "In Nayax Core, devices have various attributes, such as the device's operator, model or ID, and status. These can all be seen in the Devices menu."
---
