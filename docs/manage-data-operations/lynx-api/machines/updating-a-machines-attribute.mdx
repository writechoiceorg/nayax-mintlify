...
metadata:
  og:description: "This page uses the Lynx API to update an attribute of a machine. In the step-by-step guide below, you'll use the following endpoint: Authentication."
---
...
<Note>
  Replace `<MACHINE_ID>` with the actual machine's unique identifier you want to update the attributes for.
</Note>
