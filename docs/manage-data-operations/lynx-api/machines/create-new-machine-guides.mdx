...
metadata:
  og:description: "In Nayax Core you can create a new machine in the Machines menu, follow the steps below to do so. 1. In your Dashboard go to Operations > Machines. 2."
---
...
3. Now you can fill all the details on the form, once you are finished click **Save**.
...
<EndpointCard
  title="Create New Machine"
  href="/reference/lynx/machines/create-new-machine"
  method="post"
/>
...
| `MachineGroupID`   | ID of the group to which the machine belongs. You can view existing groups with the [List All Machine Groups for Actor](/reference/lynx/actors/get-all-machine-groups-for-actor) endpoint.                                                             |
| `MachineModelID`   | ID for the machine's model. To obtain the machine model of an existing machine, you can copy and paste the `MachineModelId` from the [Get Specific Machine Basic Info](/reference/lynx/machines/get-machine-basic-info) endpoint for a specific machine. |
