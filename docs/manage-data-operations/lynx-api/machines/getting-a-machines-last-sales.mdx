...
metadata:
  og:description: "In some cases, you may want to see the last sales of a machine to retrieve information about specific transactions. Nayax Core allows you to do so in."
---
...
2. Select your machine and click **Info > Last Sales** .
