...
metadata:
  og:description: "This page presents how to retrieve a Machine's ID using its Device ID with Lynx API and also with Nayax core. The guide will use the following."
---
