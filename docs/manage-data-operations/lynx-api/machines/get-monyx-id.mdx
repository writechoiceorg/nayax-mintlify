...
title: "Get Monyx ID"
metadata:
  og:description: "Lynx API allows you to retrieve the Monyx ID of a machine with a GET request. This page will guide you on how to do so using the endpoint below."
---
