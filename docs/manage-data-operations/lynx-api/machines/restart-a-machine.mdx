...
<Warning>
**Draft: pending Nayax confirmation.** This page is a preview built from the integration notes provided. Before it publishes, the Nayax team needs to confirm:

- Remote restart is supported through the API, including for ONYX devices.
- `PUT .../machines/{MachineID}/configuration` is a new endpoint (it is not yet in the Lynx API reference).
