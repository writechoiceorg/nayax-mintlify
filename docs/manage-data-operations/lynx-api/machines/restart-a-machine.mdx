...
After the device restarts, it sends a `PowerUp` event back to the server confirming it is online again. Use this event to verify the restart completed. In Nayax Core, find this event on the machine's page under **Info** > **Last alerts**:
