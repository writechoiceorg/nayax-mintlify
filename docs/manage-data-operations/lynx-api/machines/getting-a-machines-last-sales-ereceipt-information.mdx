...
metadata:
  og:description: "This page presents how to retrieve a Machine's Last Sales using its Machine ID with Lynx API and also with Nayax core. The guide will use the."
---
...
<EndpointCard
  ...
  href="/reference/lynx/machines/get-last-sales-for-machine"
  method="get"
/>

<EndpointCard
  title="Generate eReceipt"
  href="/reference/lynx/ereceipt/generate-ereceipt"
  method="get"
/>
</Columns>
...
To retrieve a machine's Last Sales using its Machine ID, you need to use the [Get Last Sales for Machine](/reference/lynx/machines/get-last-sales-for-machine) endpoint. By providing the machine's Machine ID in the request you can retrieve the corresponding machine's unique identifier.
...
`POST /v1/ereceipt/generate` requires permissions beyond those granted to a standard operator token. Requests with a standard token return `403 Insufficient Permissions`. Contact your Nayax account manager to have eReceipt permissions enabled for your account.
</Warning>
