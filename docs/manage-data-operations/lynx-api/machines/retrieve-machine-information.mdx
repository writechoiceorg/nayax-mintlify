...
<Columns cols={2}>
  <Card icon="link" title="Get Specific Machine Basic Info by MachineID" href="/reference/lynx/machines/get-machine-basic-info">
    GET
  </Card>

  <Card icon="link" title="Get Specific Machine Basic Info by Device" href="/reference/lynx/machines/get-machine-info-by-device">
    GET
  </Card>

  <Card icon="link" title="Get Specific Machine Basic Info by VPOS" href="/reference/lynx/machines/get-machine-info-by-vpos">
    GET
  </Card>
...
Using the [Get Specific Machine Basic Info](/reference/lynx/machines/get-machine-basic-info) you can get the details of a machine with a specific `MachineID`. See an example request in the code block below:
...
Using the [Get Specific Machine Basic Info by Device](/reference/lynx/machines/get-machine-info-by-device) endpoint, you can retrieve the details of a machine associated with a specific DeviceSerialNumber. See an example request in the code block below:
...
Using the [Get Specific Machine Basic Info by VPOS](/reference/lynx/machines/get-machine-info-by-vpos) endpoint, you can retrieve the details of a machine associated with a specific `VPOSSerial`. See an example request in the code block below:
