...
title: "Overview"
metadata:
  og:description: "Amazon SQS (Simple Queuing Service) is a Queue mechanism that allows a robust, redundant, and reliable way to transfer data between systems without the hassle of managing retry mechanisms."
---
