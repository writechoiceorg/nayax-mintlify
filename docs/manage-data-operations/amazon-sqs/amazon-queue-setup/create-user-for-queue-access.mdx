...
metadata:
  og:description: "After setting up the queue permissions, AWS requires a user account to interact with the queue programmatically. This user will utilize the."
---

After setting up the queue permissions, AWS requires a user account to interact with the queue programmatically. This user will use the previously created policy to secure queue access.
