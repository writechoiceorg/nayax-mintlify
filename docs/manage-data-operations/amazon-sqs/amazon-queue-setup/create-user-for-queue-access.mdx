...
After setting up the queue permissions, AWS requires a user account to interact with the queue programmatically. This user uses the previously created policy to secure queue access.
