...
metadata:
  og:description: "Creating an Amazon SQS queue is the first step in setting up your integration with Nayax. ## Select AWS Region Once the prerequisites are complete."
---
...
3. Search the **Application Integration** category and select **Simple Queue Service** (SQS).
