...
metadata:
  og:description: "To set up Events and Alerts Delivery to Amazon SQS, you must have access to Nayax Core with the appropriate user permissions. Specifically, the."
---
