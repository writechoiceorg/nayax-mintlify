...
You can retrieve the pick list associated with a specific machine using the [Get Pick List](/reference/get-pick-list) endpoint. See the example request below:
...
You can modify the pick list for a specific machine using the [Update Pick List](/reference/update-pick-list) endpoint. This endpoint allows you to update the quantities of products to be restocked or adjust other details in the pick list. See the example request below:
...
Using the [Delete Pick List](/reference/delete-pick-list) endpoint, you can remove the existing pick list associated with a specific machine. This endpoint helps operators clear outdated or incorrect pick lists to ensure accurate restocking processes.
