...
* `method`: Specifies the method to be used. See [Payment Services Methods](https://developerhub.nayax.com/docs/transaction-methods) and [Device Methods](https://developerhub.nayax.com/docs/device-methods) for a list and description of available methods.
