...
* `method`: Specifies the method to be used. See [Payment Services Methods](/docs/transaction-methods) and [Device Methods](/docs/device-methods) for a list and description of available methods.
