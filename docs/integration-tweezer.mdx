...
* `method`: Specifies the method to be used. See [Payment Services Methods](/docs/transaction-methods) and [Device Methods](/docs/integrate-pos-device/tweezercomm/device-methods/index) for a list and description of available methods.
...
By following this structure, you can reliably interact with TweezerComm for secure and efficient payment processing.
...
<Card
  ...
  href="/docs/tweezercomm-create-payments"
  arrow
/>
</Columns>