...
The diagram below exemplifies a Closed Loop transaction.

<Frame>![](images/docs/closed-loop-transaction/images1.png)</Frame>
...
7. The host application uses a UID card to authorize the transaction with their application server.
8. Once approved, the transaction is complete.
9. The product is then delivered to the buyer successfully.
