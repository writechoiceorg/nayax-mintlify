...
The customer machine information is mandatory for the VMC configuration. These are the `model`, `serial`, `hw_ver`, and the `manuf_code`. Read more about these fields in [VMC Configuration Object](https://developerhub.nayax.com/docs/vmc-configuration-object).
</Warning>
...
<Card
  ...
  href="/v1.0/docs/c-sdk-integration"
  arrow
/>
<Card
