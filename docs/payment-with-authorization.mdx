...
<Callout icon="📘" theme="info">
  If you prefer, you can perform the authorization and settlement in just one step. To learn more about this process, visit the [Single Step Payment](https://developerhub.nayax.com/docs/single-step-payment) page.
</Callout>
...
4. The Host application can now confirm the transaction. The [`ConfirmTransaction`](https://developerhub.nayax.com/docs/payment-1#confirmtransaction) operation must be used to inform the transaction ID and the amount to be charged.
