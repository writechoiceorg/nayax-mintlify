...
<Columns cols={2}>
  <Card icon="link" title="Android SDK Installation" href="/docs/emv-core-android-installation" />

  <Card icon="link" title="Linux SDK Installation" href="/docs/emv-core-linux-installation" />
</Columns>
