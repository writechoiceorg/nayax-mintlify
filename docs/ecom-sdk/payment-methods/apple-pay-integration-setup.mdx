...
metadata:
  og:description: "To enable Apple Pay as a payment method with the Nayax eCom SDK, you must verify your merchant domain. Follow these steps to complete the integration."
---
