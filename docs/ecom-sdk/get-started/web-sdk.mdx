...
title: "Web SDK"
metadata:
  og:description: "Nayax provides a Web version of the eCom SDK. This guide shows you how to integrate it into your application. You will learn how to install."
---
...
2. The `NayaxEcomConfig` interface encapsulates the essential properties for SDK configuration:
