...
metadata:
  og:description: "The startPayment method is the primary entry point for initiating a payment flow within your application using the Nayax eCom SDK. The method."
---
...
| :-------------------- | :-------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `merchantRequestId`      | String                                                                | The actor's own transaction reference ID. Passed through to the webhook notification as `MerchantTransactionId`.                                                                                                                                                                                                                                                                                                                                                                                                               |
