...
metadata:
  og:description: "The eCOM SDK supports comprehensive customization of its Mobile (iOS/Android) and Web UI components, enabling you to align the checkout experience."
---
...
For web integrations, the SDK's styling is primarily driven by CSS Custom Properties (CSS Variables), enabling global theme overrides without modifying the core library code.
