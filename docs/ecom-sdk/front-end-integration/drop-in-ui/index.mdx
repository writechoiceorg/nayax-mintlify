...
title: "Drop-in UI"
metadata:
  og:description: "The Drop-in UI component allows you to easily display a complete, pre-configured list of available Payment Methods anywhere on your website."
---

The Drop-in UI component allows you to display a complete, pre-configured list of available payment methods anywhere on your website, minimizing development time for integration.
