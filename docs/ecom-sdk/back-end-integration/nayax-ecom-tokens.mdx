...
Use the [ `/charge-token`](/reference/ecom/payments/charge-token) endpoint for recurring payments. It should be used for recurring payment calls and requires a card token to be added to the request. Perform these calls only on the server.
