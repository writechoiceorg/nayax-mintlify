...
<CardGroup cols={1}>
  <Card icon="webhook" title="Webhook Notifications" href="/docs/ecom-sdk/back-end-integration/webhook-notifications">
    Receive automated status updates on your back end for every eCom transaction.
  </Card>
</CardGroup>