...
title: "Refunds"
metadata:
  og:description: "This request initiates the refund process by referencing the unique identifiers of the original, captured transaction."
---
...
| :------------------- | :-------- | :------- | :------------------------------------------------------------------------------------------------------------------------ | :------------------ |
| `RequestType`        | basicInfo | Int32    | The request type can be 4 for `Full Refund` or 5 for `Partial Refund`.                                                                           | Yes                 |
