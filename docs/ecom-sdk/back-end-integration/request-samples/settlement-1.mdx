...
title: "Settlement"
metadata:
  og:description: "This request is used to finalize or capture funds from a previously authorized transaction."
---
...
| `validationKey`      | Root      | String   | The key obtained from the `/validate-merchant` response, used to authenticate all subsequent API calls within the same transaction session. | **Yes**                     |
