...
<Cards columns={3}>
  <NayaxCard title="Get Started" href="/v1.0/docs/marshall-get-started" />

  <NayaxCard title="Payment Flows" href="/v1.0/docs/marshall-payment-flows" />

  <NayaxCard title="Create Payments" href="/v1.0/docs/marshall-create-payments" />
</Cards>
