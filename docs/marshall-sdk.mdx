...
<Columns cols={3}>
  <Card title="Get Started" href="/docs/marshall-get-started" />

  <Card title="Payment Flows" href="/docs/marshall-payment-flows" />

  <Card title="Create Payments" href="/docs/marshall-create-payments" />
</Columns>
