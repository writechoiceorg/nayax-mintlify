...
<CardGroup cols={3}>
  <Card title="Get Started" href="/docs/tweezercomm-get-started" icon="arrow-up-right" />
  <Card title="Global Payment Flows" href="/docs/payment-flows-copy-1" icon="arrow-up-right" />
  <Card title="Global Payment Methods" href="/docs/payment-services-methods-copy-1" icon="arrow-up-right" />
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="Get Started" href="/docs/tweezercomm-get-started" icon="arrow-up-right" />
  <Card title="Israel Payment Flows" href="/docs/tweezercomm-israel-payment-flows" icon="arrow-up-right" />
  <Card title="Israel Payment Methods" href="/docs/tweezercomm-israel-payment-methods" icon="arrow-up-right" />
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="Device Methods" href="/docs/integration-tweezer" icon="arrow-up-right" />
  <Card title="TC Service" href="/docs/tc-service" icon="arrow-up-right" />
  <Card title="Resilience Mechanism" href="/docs/resilience-flow" icon="arrow-up-right" />
  <Card title="Additional Resources" href="/docs/additional-resources" icon="arrow-up-right" />
</CardGroup>
