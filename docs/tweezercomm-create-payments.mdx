...
This guide shows you how to create [ `doTransaction`](/docs/dotransaction) requests for both pre-authorization and single-step payments. You will learn to configure the JSON-RPC parameters and specify transaction-specific details.
