...
* <Anchor label="`StartAuthentication`" target="_blank" href="https://developerhub.nayax.com/update/reference/post_startauthentication">`StartAuthentication`</Anchor>
* <Anchor label="`ExternalSettlement`" target="_blank" href="https://developerhub.nayax.com/update/reference/post_externalsettlement">`ExternalSettlement`</Anchor>
* <Anchor label="`ExternalCancel`" target="_blank" href="https://developerhub.nayax.com/update/reference/post_externalcancel">`ExternalCancel`</Anchor>
...
3. **/StartAuthentication:** After the service or product is provided (or fails to be provided), the 3rd Party Server initiates communication by calling the [StartAuthentication](https://developerhub.nayax.com/reference/post_startauthentication) method. This call must include an encrypted cipher to securely authenticate both Nayax and the integrator.
...
5. **/ExternalCancel:** The 3rd Party Server sends an [ExternalCancel](https://developerhub.nayax.com/reference/post_externalcancel) request. This is **mandatory** to release the consumer's captured funds if no service was delivered. For **Pre-Selection** flows, this method is referred to as a **Void**, while for **Pre-Authorization**, it is a **Cancel**.
