...
5. **/ExternalCancel:** The 3rd Party Server sends an [ExternalCancel](/reference/post_externalcancel) request. This is **mandatory** to release the consumer's captured funds if no service was delivered. For **Pre-Selection** flows, this method is referred to as a **Void**, while for **Pre-Authorization**, it is a **Cancel**.
