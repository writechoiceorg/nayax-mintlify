...
1. Log in to the **Nayax Core**.
   ...
   <Frame>![Nayax Core Login](images/docs/set-up-transaction-delivery/images1.png)</Frame>

2. Go to **Administration > Operator**.

   <Frame>![Administration Operator Menu](images/docs/set-up-transaction-delivery/images2.png)</Frame>
...
6. Go to the **Transactions Report** tab.
   ...
   <Frame>![Transactions Report Tab](images/docs/set-up-transaction-delivery/images3.png)</Frame>
...
7. Set up Transaction Dispatching by completing the following steps:
   ...
   * Declined Transactions
   ...
   <Frame>![SQS Configuration Settings](images/docs/set-up-transaction-delivery/images4.png)</Frame>

8. Click the **Save Information** button to apply the changes.

   <Frame>![Save Information Button](images/docs/set-up-transaction-delivery/images5.png)</Frame>
