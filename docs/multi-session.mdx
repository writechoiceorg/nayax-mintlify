...
This function handles the session and the included items and sends a vending request to the Nayax Device. See the code block below:
...
It initializes `session_products` 0 and 1, each with a different product code and price. Each of those would be a seperate session (transaction).
This is of course a demo app, meaning you can (and should) manage your own products and prices to match your peripheral's.
