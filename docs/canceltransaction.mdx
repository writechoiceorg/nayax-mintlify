...
metadata:
  og:description: "The CancelTransaction endpoint allows you to cancel a transaction that is in progress. In the Pre-Authorization flow, this method is called Cancel."
---

The `CancelTransaction` endpoint allows you to cancel a transaction that is in progress.

The Pre-Authorization flow calls this method "Cancel," and the Pre-Selection flow calls it "Void."
