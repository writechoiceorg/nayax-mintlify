...
metadata:
  og:description: "The StartAuthentication endpoint is the first step in any Spark transaction. It authenticates the transaction request using a pre-shared token and a."
---
...
Send a POST request to the `/spark/StartAuthentication` endpoint with the following body:
