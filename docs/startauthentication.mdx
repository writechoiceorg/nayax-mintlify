...
This request must be signed with the `Signature `and `IntegratorId `headers. See [Security & Authentication](https://developerhub.nayax.com/docs/spark-security-authentication) to learn more.
</Warning>
