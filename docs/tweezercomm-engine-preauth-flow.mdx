...
1. After the cardholder selects the product or service, the Machine sends a [`doTransaction()`](/docs/dotransaction) Request to the Agamento Application through TweezerComm.
