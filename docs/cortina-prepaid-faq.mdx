...
<Accordion title="Answer" icon="fa-info-circle">
  ...
  * It must be included and encrypted in the `StartSession` response body. (For full details, please refer to the [Start Session authentication process](https://developerhub.nayax.com/docs/cortina-auth#/)).
