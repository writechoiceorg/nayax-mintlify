...
metadata:
  og:description: "The print method provides direct access to the VPOS terminal's integrated thermal printer. This allows the client application to generate physical."
---
