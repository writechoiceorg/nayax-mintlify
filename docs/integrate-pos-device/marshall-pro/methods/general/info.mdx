...
metadata:
  og:description: "The info method exchanges version information and device metadata between the client application (POS/FCC) and the VPOS terminal. This typically."
---
