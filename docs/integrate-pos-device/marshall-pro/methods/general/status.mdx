...
metadata:
  og:description: "The status method retrieves the current operational state of the VPOS payment terminal. This endpoint is essential for monitoring hardware readiness."
---
...
![displaySelect](/images/nayax-display.png)
