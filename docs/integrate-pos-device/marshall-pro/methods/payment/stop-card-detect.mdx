...
metadata:
  og:description: "The stopCardDetect method is a utility command used to manually deactivate the terminal's reader. This serves to maintain control over the user."
---
