...
metadata:
  og:description: "The authorize method places a financial hold (pre-authorization) on a previously identified card. This represents the second phase of a two-step."
---
