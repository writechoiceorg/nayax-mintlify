...
metadata:
  og:description: "The pay method initiates an immediate transaction where detection, authorization, and settlement occur in one continuous flow. Unlike the two-phase."
---
