...
metadata:
  og:description: "This guide walks through the Two-Phase Pre-Authorization fueling flow. This sequence allows for external data collection (such as plate numbers)."
---
...
![pre-auth-flow](/images/pre-auth-flow.png)
...
8. The fueling session takes place (**Start refuel → End refuel**).
