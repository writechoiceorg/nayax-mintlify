...
metadata:
  og:description: "This guide walks through the post-pay flow. Unlike pre-authorization sequences, this simplified flow is used when the final transaction amount is."
---
