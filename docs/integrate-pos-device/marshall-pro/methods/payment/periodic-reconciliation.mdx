...
metadata:
  og:description: "This guide walks through the periodic reconciliation flow. This maintenance sequence is designed to run at regular intervals to identify any."
---
...
![periodic-reconciliation](/images/periodic-reconciliation.png)
