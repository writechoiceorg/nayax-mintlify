...
metadata:
  og:description: "The settle method is the final step in the fuel transaction lifecycle. It captures' or finalizes a previously authorized transaction once the."
---
