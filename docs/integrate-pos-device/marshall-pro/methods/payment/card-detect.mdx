...
metadata:
  og:description: "The cardDetect method activates the terminal's reader to identify and capture data from a payment method (Card or QR) without initiating a financial."
---
...
![cardDetect](/images/approved.jpg)
