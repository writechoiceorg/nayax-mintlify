...
keywords: ["marshall pro api", "Marshall PRO", "forecourt controller", "fuel dispenser", "two-phase authorization"]
metadata:
  og:description: "The Marshall Pro (Fuel) protocol is a high-performance, command-based interface designed for fuel retail environments. It allows your Point-of-Sale."
---
