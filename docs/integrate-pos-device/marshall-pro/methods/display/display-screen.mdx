...
metadata:
  og:description: "The displayScreen method allows the client application (POS/FCC) to take control of the terminal's display. This serves to guide the customer through."
---
