...
metadata:
  og:description: "The displaySelect method allows the client application to present a menu or a list of choices to the customer. This serves as a key component for."
---
