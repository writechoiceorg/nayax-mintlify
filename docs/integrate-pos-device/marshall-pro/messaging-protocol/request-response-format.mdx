...
metadata:
  og:description: "The Marshall Pro protocol uses a unified JSON structure for every message. This consistency allows you to build a single wrapper' in your code."
---
