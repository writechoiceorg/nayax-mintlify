...
metadata:
  og:description: "## Connection & Protocol The VPOS acts as a TCP/IP server on Port 5050. Your system (POS/FCC) acts as the client and must initiate the connection."
---
