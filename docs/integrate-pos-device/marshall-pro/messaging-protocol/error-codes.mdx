---
title: "Error Codes"
keywords: ["error", "error codes", "error code", "protocol errors", "payment errors", "errorCode", "errorMessage", "card blocked", "transaction canceled", "FuelApp error", "VPOS service error"]
metadata:
