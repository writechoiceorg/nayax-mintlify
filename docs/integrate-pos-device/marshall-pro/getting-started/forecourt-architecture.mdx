...
metadata:
  og:description: "The Marshall Pro (Fuel) integrates into a complex ecosystem involving local hardware, forecourt controllers, and multiple backend authorization."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Point of Sale (POS)" icon="cash-register">
     The system managing the c-store in a forecourt environment.
  </Card>
