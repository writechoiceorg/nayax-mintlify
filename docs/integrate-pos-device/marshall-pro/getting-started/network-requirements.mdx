...
metadata:
  og:description: "Marshall Pro (Fuel) supports the VPOS Media-5 terminal alongside forecourt controllers. Before you deploy any Marshall Pro hardware, your network team."
---
