...
title: "Overview"
metadata:
  og:description: "The Marshall Pro (Fuel) protocol is a command-based JSON interface designed for clear communication between a Point-of-Sale (POS) or ForeCourt."
---
