...
metadata:
  og:description: "### Request IDs Every request must have a unique identifier. Format: Alphanumeric with hyphens (e.g., refuel-12345). Context: Include business logic."
---
