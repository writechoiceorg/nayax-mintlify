...
title: "StopCallback"
metadata:
  og:description: "Enable StopCallback This feature must be enabled in Nayax Core during the integration. The StopCallback endpoint It is used to notify the integrator."
---
