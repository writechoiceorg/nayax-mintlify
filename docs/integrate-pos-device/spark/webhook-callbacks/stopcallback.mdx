...
title: "StopCallback"
metadata:
  og:description: "Enable StopCallback This feature must be enabled in Nayax Core during the integration. The StopCallback endpoint is used to notify the integrator."
---
...
Spark sends a POST request to your configured `StopCallback` endpoint. 

The call would be sent to the following endpoint:

`(Customer's URL)/StopCallback`

The body parameters are as in the example below:
