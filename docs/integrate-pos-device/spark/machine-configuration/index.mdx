...
the Nayax back-office system. Confirm your Operator is linked to your Spark provider and
select or create the machine, then follow the page for the feature you are integrating.
...
<CardGroup cols={2}>
  ...
  <Card title="Device Start Configuration" icon="hand-pointer" href="/docs/integrate-pos-device/spark/machine-configuration/spark-device-start-configuration">
