...
This request must be signed with the `Signature` and `IntegratorId` headers. See [Security & Authentication](/docs/integrate-pos-device/spark/deprecated/spark-security-authentication) to learn more.
</Warning>
