...
title: "Device Start"
metadata:
  og:description: "The Device Start flow initiates directly at the Nayax terminal, allowing consumers to begin a session by selecting a service or presenting their card."
---
