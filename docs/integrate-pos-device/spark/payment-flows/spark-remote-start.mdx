...
1. A consumer starts a session on a service station, which sends a [`StartAuthentication`](/docs/integrate-pos-device/spark/deprecated/startauthentication) request to the Nayax Server via a 3rd Party Server.
2. The Nayax Server responds to the 3rd Party Server with a [`StartAuthenticationResponse`](/docs/integrate-pos-device/spark/deprecated/startauthentication).
3. The 3rd Party Server sends a [`TriggerTransaction`](/docs/integrate-pos-device/spark/deprecated/triggertransaction) request to the Nayax Server.
...
6. The Nayax Server sends a [`TriggerTransactionResponse`](/docs/integrate-pos-device/spark/deprecated/triggertransaction) back to the 3rd Party Server.
...
11. The 3rd Party Server sends a [`Settlement`](/docs/integrate-pos-device/tweezercomm/deprecated/settlement) request to the Nayax Server.
12. The Nayax Server performs the settlement with the Payment Provider and sends a [`SettlementResponse`](/docs/integrate-pos-device/tweezercomm/deprecated/settlement) back to the 3rd Party Server.
...
1. A consumer starts a session on a service station, which sends a [`StartAuthentication`](/docs/integrate-pos-device/spark/deprecated/startauthentication) request to the Nayax Server via a 3rd Party Server.
2. The Nayax Server responds to the 3rd Party Server with a [`StartAuthentication`](/docs/integrate-pos-device/spark/deprecated/startauthentication) Response.
3. The 3rd Party Server sends a [`TriggerTransaction`](/docs/integrate-pos-device/spark/deprecated/triggertransaction) request to the Nayax Server.
4. The Nayax Server sends a "Wake Up" command to the Nayax Device.
5. The Nayax Device responds to the Nayax Server, confirming it has woken up.
6. The Nayax Server sends a [`TriggerTransaction`](/docs/integrate-pos-device/spark/deprecated/triggertransaction) response back to the 3rd Party Server.
7. The consumer presents their card to the Nayax Device. The Nayax Device then sends an `AuthorizationRequest` to the Nayax Server.
...
<Card
  ...
  href="/docs/integrate-pos-device/spark/deprecated/startauthentication"
  arrow
/>
<Card
  icon="link"
  title="TriggerTransaction"
  href="/docs/integrate-pos-device/spark/deprecated/triggertransaction"
  arrow
/>
<Card
  icon="link"
