...
2. The Nayax Server responds to the 3rd Party Server with a [`StartAuthenticationResponse`](/docs/startauthentication).
...
6. The Nayax Server sends a [`TriggerTransactionResponse`](/docs/triggertransaction) back to the 3rd Party Server.
...
12. The Nayax Server performs the settlement with the Payment Provider and sends a [`SettlementResponse`](/docs/settlement) back to the 3rd Party Server.
