...
metadata:
  og:description: "The Spark External Settlement feature allows third-party servers to complete or cancel transactions authorized directly on a Nayax payment terminal."
---
...
* **Card Scheme Compliance**: Transactions that remain unsettled for too long will be automatically canceled by the system. However, you must not rely on this and should send an External Cancel immediately if no settlement will occur to avoid poor user experience and potential disputes.
