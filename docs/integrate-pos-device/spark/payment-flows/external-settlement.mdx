...
<Columns cols={3}>
  <Card title="StartAuthentication" icon="link" href="/reference/spark/transactions/startauthentication">
  </Card>

  <Card title="ExternalSettlement" icon="link" href="/reference/spark/transactions/externalsettlement">
  </Card>

  <Card title="ExternalCancel" icon="link" href="/reference/spark/transactions/externalcancel">
  </Card>
</Columns>