...
metadata:
  og:description: "This page details the required format for data sent to the Nayax POS device for display. Adhering to this format ensures information is presented."
---
