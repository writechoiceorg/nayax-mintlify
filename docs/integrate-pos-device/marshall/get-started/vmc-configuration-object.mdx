...
keywords: ["vmc_link", "VMC", "vending machine controller", "MDB", "MDB protocol", "vmc_configuration", "mandatory fields", "machine serial number", "hw_ver", "manuf_code", "multi-session support", "multi-vend support", "RS232"]
metadata:
  og:description: "The vmcconfiguration class is used to set up various parameters and flags that control the behavior of the peripheral. Proper configuration is."
---
...
<Frame><img src="/images/docs/vmc-configuration-object/image1.png" /></Frame>
