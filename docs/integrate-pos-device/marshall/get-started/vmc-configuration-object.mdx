...
keywords: ["vmc_link", "VMC", "vending machine controller", "MDB", "MDB protocol", "vmc_configuration", "mandatory fields", "machine serial number", "hw_ver", "manuf_code", "multi-session support", "multi-vend support"]
metadata:
