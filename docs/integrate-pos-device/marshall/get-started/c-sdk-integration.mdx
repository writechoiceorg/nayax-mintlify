...
metadata:
  og:description: "C SDK Only The functions and information on this page are relevant only for the C SDK . This guide shows you how to integrate the Marshall C SDK into."
---
...
The customer machine information are mandatory fields for the VMC configuration, these are the `model`, `serial`, `hw_ver` and the `manuf_code`. Read more about these fields in [VMC Configuration Object](/docs/integrate-pos-device/marshall/get-started/vmc-configuration-object).
</Note>
