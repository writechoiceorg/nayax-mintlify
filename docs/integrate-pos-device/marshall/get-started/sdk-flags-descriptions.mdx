...
<table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Determines the level of detail required to log messages generated by the SDK. You can read more about this in the [Log generation](/docs/integrate-pos-device/marshall/log-analysis/log-generation) page.
      </td>
    </tr>
  </tbody>
</table>