---
title: "SDK Flags"
keywords: ["sdk", "SDK flags", "marshall sdk", "marshal", "vend_denied_policy", "configuration flags", "multi_vend_support", "multi_session_support", "reader_always_on", "always_idle", "explicit_vend_success", "mifare card support", "qr_approved_by_vmc_support", "vending machine controller", "RS232"]
metadata:
  og:description: "The vmcconfiguration object allows you to set various configuration flags. When using the Marshall SDK, these determine the behavior and capabilities."
---
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        You can read more on that in the [Multi-Session](/docs/integrate-pos-device/marshall/payment-flows/marshall-multi-session#/) page.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Determines the level of detail required to log messages generated by the SDK. You can read more about this in the [Log generation](/docs/integrate-pos-device/marshall/additional-resources/log-generation) page.
      </td>
    </tr>
  </tbody>
</table>