...
keywords: ["vmc_link", "vmc_link_events_t", "link events", "VMC link", "vpos_config_t", "onReady", "onCommError", "VPOS configuration", "communication error", "acquirer terminal id"]
metadata:
