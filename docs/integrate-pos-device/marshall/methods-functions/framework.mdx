...
title: "Framework"
metadata:
  og:description: "The vmcframework is the core component of the Marshall SDK, acting as the primary interface between your application and the vending machine."
---
