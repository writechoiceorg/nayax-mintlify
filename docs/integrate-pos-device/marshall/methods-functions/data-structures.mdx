...
metadata:
  og:description: "This page covers the data structures used in the Marshall SDK to handle vending product requests and sessions. Such as: venditemt vendsessiondatat."
---
...
| `qty`     | Int             | The quantity of the product being vended.                                                           |
