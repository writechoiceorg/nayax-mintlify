...
Before getting started with the Marshall SDK, please read the [Terms of Service](/docs/terms-of-service) of our developer's zone.
</Note>

To start the Marshall SDK integration, we suggest you check the following documentation pages:

<Columns cols={3}>
  <Card icon="link" title="Get Started" href="/docs/marshall-get-started" />

  <Card icon="link" title="Payment Flows" href="/docs/marshall-payment-flows" />

  <Card icon="link" title="Create Payments" href="/docs/marshall-create-payments" />
</Columns>
