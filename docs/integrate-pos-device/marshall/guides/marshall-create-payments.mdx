...
If you have not finished the integration process, check the [Get Started](/docs/marshall-get-started)  page before continuing.
</Warning>
...
More on that on [Decimal Place](/docs/faq#decimal-place).
