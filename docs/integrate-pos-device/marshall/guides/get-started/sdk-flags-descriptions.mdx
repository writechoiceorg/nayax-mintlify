  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        You can read more on that in the [Multi-Session](/docs/marshall-multi-session#/)  for more details.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Determines the level of detail required to log messages generated by the SDK. You can read more on that in the [Log generation](/docs/log-generation) for more details.
      </td>
    </tr>
  </tbody>
</table>