...
metadata:
  og:description: "The single-session payment in Nayax allows only one transaction to be processed. Unlike multi-session, where multiple transactions can run."
---
