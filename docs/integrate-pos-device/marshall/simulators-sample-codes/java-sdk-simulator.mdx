...
metadata:
  og:description: "The Nayax Marshall SDK includes a simulator to help developers test and debug their implementation with the Nayax payment system. The simulator."
---
...
<table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      <td>
        transfer custom transaction\_id
      </td>
