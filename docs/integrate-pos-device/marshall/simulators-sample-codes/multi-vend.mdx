...
metadata:
  og:description: "The multi-vend flow in Nayax allows consumers to purchase multiple items within a single payment session and for the peripheral to have."
---
...
Now you can initialize the menu by linking the handlers you created earlier. See the code below.
