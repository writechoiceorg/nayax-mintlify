...
The feature is only supported on VPOSM and for Java and C# SDKs (not supported on C SDK). All you'd need to do is set the eth\_port's configuration instead of the pc\_port, and ensure that the device and machine are located inside the same network.
