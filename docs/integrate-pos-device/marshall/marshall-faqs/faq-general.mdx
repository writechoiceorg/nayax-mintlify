...
**C SDK:**
Our SDK developer estimates its memory usage at around 1KB of RAM and every 5mv, timer tick of around 100 lines of code (actual machine code depends on compiler and platform).
...
ftdi is for USB serial port converter.