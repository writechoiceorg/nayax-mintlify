...
•	Note: when working with the lowlevel serial for Android, you wouldn't be able to play with the demo app, but you can use it as a reference as to how to initiate transactions
