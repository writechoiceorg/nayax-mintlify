...
**C SDK:**
Our SDK developer estimates its memory usage in around 1KB of RAM and every 5ms, timer tick of around 100 lines of code (actual machine code depends on compiler and platform).
