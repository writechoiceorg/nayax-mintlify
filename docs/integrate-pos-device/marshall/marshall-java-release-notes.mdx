...
<Note>
Some features shipped in the 0.1.6.x patch line require VPOS version 4.0.8.23-RC3 or newer. Check the version history below for the patch that introduced the feature you're using.
</Note>
