...
metadata:
  og:description: "Display Control is a Preselection feature that allows a transaction process to begin by selecting a product on the Nayax device, with the consumer."
---
...
<Frame>![Idle state image and animation selection in the DCS back office](/images/docs/faq/image5.png)</Frame>

Change the **Please select a product** title.

<Frame>![Setting for the product selection title](/images/docs/faq/image6.png)</Frame>

Change the title shown in idle mode.

<Frame>![Setting for the idle mode title](/images/docs/faq/image7.png)</Frame>

Change the product selection message.

<Frame>![Setting for the product selection message](/images/docs/faq/image8.png)</Frame>

Remove the audio on the product selection screen.

<Frame>![Setting to remove the product selection screen audio](/images/docs/faq/image9.png)</Frame>

Remove any of the following audio prompts.

<Frame>![First group of removable audio prompts](/images/docs/faq/image10.png)</Frame>

<Frame>![Second group of removable audio prompts](/images/docs/faq/image11.png)</Frame>
...
<Frame>![Setting to remove the end of transaction thank you message](/images/docs/faq/image12.jpg)</Frame>
...
<Frame>![Machine File screen used to send the animation file to the device](/images/docs/faq/image13.png)</Frame>
...
<Frame>![Configuration that activates the Smartfridge selection animation](/images/docs/faq/image14.png)</Frame>
