...
metadata:
  og:description: "# Introduction ## What can cause stability issues in the Marshall link? These stability issues usually happen due to not using proper hardware: 1."
---
...
Should your peripheral continue to not respond (each packet would be sent once and would have another possible 2 retries which would try and get a response from your machine- would go into details about it below in the section about keepalives)- the Marshall link would be deemed broken.
