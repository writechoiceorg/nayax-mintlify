...
title: "Capabilities"
metadata:
  og:description: "The information regarding the SDK's flags is being sent within the FirmwareInfo() function during the pairing process. Each of those bits turn."
---
