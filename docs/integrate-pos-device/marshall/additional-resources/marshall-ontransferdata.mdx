...
title: "Transfer Data"
metadata:
  og:description: "onTransferData is the function for the Transfer Data' Marshall command, which allows for information regarding the transaction to be sent both ways-."
---
