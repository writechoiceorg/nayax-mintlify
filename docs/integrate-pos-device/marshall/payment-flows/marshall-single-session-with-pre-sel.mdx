...
metadata:
  og:description: "This guide walks through the Pre-Selection vending flow. You'll understand the sequence of events that separate product selection from payment."
---
