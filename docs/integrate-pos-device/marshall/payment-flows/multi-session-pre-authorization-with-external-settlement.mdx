...
metadata:
  og:description: "This guide explains the Multi-Session Pre-Authorization with External Settlement flow. This method allows for multiple transactions to be manages in."
---
