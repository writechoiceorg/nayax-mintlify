...
<Frame><img src="/images/docs/faq-marshall-flowconfigurations/image1.png" alt="SDK log showing the authorization arriving before Begin Session for a prepaid card" /></Frame>

With every other card type, Begin Session comes first and the authorization follows.

<Frame><img src="/images/docs/faq-marshall-flowconfigurations/image2.png" alt="SDK log showing Begin Session arriving before the authorization" /></Frame>
