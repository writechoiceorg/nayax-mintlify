...
<Columns cols={2}>
  <Card icon="link" title="Single Session with Pre-Selection" href="/docs/integrate-pos-device/marshall/payment-flows/marshall-single-session-with-pre-sel" />

  <Card icon="link" title="Single Session with Pre-Authorization" href="/docs/integrate-pos-device/marshall/payment-flows/marshall-single-session-with-pre-auth" />
</Columns>

<Columns cols={3}>
  <Card icon="link" title="Multi-Vend with Pre-Selection" href="/docs/integrate-pos-device/marshall/payment-flows/marshall-multi-vend-with-pre-sel" />

  <Card icon="link" title="Multi-Vend with Pre-Authorization" href="/docs/integrate-pos-device/marshall/payment-flows/marshall-multi-vend-with-pre-auth" />

  <Card icon="link" title="Multi-Session" href="/docs/integrate-pos-device/marshall/payment-flows/marshall-multi-session" />
</Columns>
