...
metadata:
  og:description: "This guide explains the Multi-Vending with Pre-Authorization flow. This method allows a customer to purchase multiple products in one session after a."
---
...
<Frame><img src="/images/docs/faq-marshall-flowconfigurations/image3.png" alt="Demo app showing five selected items in a multi-vend session" /></Frame>

To simulate only two of them being vended, add the following inside the `onVendApproved` callback of your demo app:

<Frame><img src="/images/docs/faq-marshall-flowconfigurations/image4.png" alt="onVendApproved callback in the demo app with the partial vending code added" /></Frame>
...
<Card
  ...
  title="Payment Flows"
  href="/docs/integrate-pos-device/marshall/payment-flows/marshall-payment-flows"
>
