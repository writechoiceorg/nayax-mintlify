---
title: "Multi-Vending with Pre-Selection"
metadata:
  og:description: "With the Multi-Vending flow, your machine can dispense multiple products (up to 20, as of 4.0.25.9 and above, up to 40) in a single transaction."
---
...
<Frame><img src="/images/docs/marshall-multi-vend-with-pre-sel/image1.png" /></Frame>
...
12. The peripheral dispenses the products to the consumer.
13. The SDK reports "vend success":
    ...
    <Frame><img src="/images/docs/marshall-multi-vend-with-pre-sel/image2.jpg" /></Frame>
