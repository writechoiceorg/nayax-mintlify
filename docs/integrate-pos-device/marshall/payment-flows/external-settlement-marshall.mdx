...
metadata:
  og:description: "Separate authorization and settlement for Marshall integrations, letting a 3rd-party server trigger final settlement or cancellation via the Nayax API."
---
