...
metadata:
  og:description: "This guide explains the Pre-Authorization vending flow. This process is key to minimizing risk because it approves payment before the customer."
---
