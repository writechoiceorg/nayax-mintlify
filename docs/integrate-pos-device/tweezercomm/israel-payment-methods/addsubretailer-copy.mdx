...
metadata:
  og:description: "The getSubRetailer method retrieves a list of all sub-retailers loaded on the terminal and shows their current status. ## Request JSON-RPC 2.0."
---
