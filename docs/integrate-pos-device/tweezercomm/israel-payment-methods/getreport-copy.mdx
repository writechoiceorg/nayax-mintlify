...
title: "getStatus"
metadata:
  og:description: "The getStatus method checks the status of the AEA (the payment application) service to see if it's ready to process transactions (as opposed."
---
