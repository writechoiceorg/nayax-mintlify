...
title: "doPeriodic"
metadata:
  og:description: "The doPeriodic method should be called at least once a day to deposit transactions and update the AEA database. This method generates a Z report."
---

Call the `doPeriodic` method at least once a day to deposit transactions and update the AEA database. This method generates a Z report summarizing the day's transactions.
