...
metadata:
  og:description: "The authorizePendingTransactions method processes and finalizes all transactions that are currently in a pending state. This method is essential for."
---
