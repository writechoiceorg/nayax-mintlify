...
title: "getReport"
metadata:
  og:description: "Use the getReport method to retrieve various reports, such as Z or X reports, and lists of specific transaction types. ## Request JSON-RPC 2.0."
---
