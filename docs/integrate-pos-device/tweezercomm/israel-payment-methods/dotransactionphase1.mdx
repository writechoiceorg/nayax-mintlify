...
| `payments` | integer | The number of payments, not including the first payment.<br />For example, if payments value is 2, the actual number of payments for the consumer would have is 3.<br />If the firstPaymentAmount is not provided in the request- all of the payments will be divided equally. |
