...
metadata:
  og:description: "Use the cancelTransaction method to cancel a transaction that has already been approved and is registered in the database. Such a transaction can be."
---
