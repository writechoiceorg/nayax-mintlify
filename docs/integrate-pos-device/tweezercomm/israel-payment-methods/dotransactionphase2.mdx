...
metadata:
  og:description: "The doTransactionPhase2 method completes the transaction that was started with doTransactionPhase1. Only the vuid is required to complete the."
---
...
All methods in TweezerComm follow a JSON-RPC 2.0 structure. See [Integration](/docs/integrate-pos-device/tweezercomm/deprecated/integration-tweezer) for more details on how the requests are structured and sent.
</Note>
...
<table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Credit card payment options. Values are:
        `1` (Regular),
        `2` (Special Credit),
        `3` (Immediate),
        `6` (Credit),
    ...
    <tr>
      ...
      <td>
        The index to which the payments are linked. Values are:
        `1` (Linked to Madad),
        `2` (Linked to Dollar)
      </td>
    </tr>
