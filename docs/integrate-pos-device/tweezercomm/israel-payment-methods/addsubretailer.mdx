...
metadata:
  og:description: "Use the addSubRetailer method to load sub-retailers into the terminal. This method can only be used if the main retailer is defined as RAV-SAPAK at."
---
