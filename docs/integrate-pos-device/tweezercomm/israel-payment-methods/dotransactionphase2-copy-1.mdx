...
metadata:
  og:description: "The removeSubRetailer method removes a sub-retailer from the terminal. ## Request JSON-RPC 2.0 All methods in TweezerComm follow a JSON-RPC 2.0."
---
