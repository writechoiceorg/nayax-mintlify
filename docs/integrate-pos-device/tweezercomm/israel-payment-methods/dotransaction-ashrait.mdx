...
title: "doTransaction"
metadata:
  og:description: "The doTransaction method initiates and processes payment transactions within the TweezerComm protocol. It enables client applications, such as."
---
...
<table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The transaction code. Below are the possible values for this parameter:
