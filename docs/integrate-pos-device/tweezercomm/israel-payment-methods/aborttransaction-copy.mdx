...
metadata:
  og:description: "The abortTransaction method cancels an ongoing transaction before it is registered in the database, meaning before a doTransaction Response is."
---
