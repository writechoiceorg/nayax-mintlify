...
metadata:
  og:description: "The getTransactionByVuid method retrieves a transaction using its vendor-unique identifier (void). This allows client applications to fetch."
---
