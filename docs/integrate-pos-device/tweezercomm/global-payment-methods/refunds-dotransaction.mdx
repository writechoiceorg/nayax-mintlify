...
title: "Refunds"
metadata:
  og:description: "The doTransaction method allows you to process refunds. There are two primary scenarios for this operation: Standard Refund: Done on the same."
---
...
Use a Standard Refund when you need to reverse a transaction or partially returned using the same terminal that processed the original sale.
