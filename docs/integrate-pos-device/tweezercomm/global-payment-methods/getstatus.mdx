...
title: "getStatus"
metadata:
  og:description: "The getStatus method returns the current AEA service status and informs the client whether the payment engine is ready to process transactions (as."
---
