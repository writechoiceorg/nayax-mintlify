...
title: "getReport"
metadata:
  og:description: "Use the getReport method to retrieve service transaction reports. It provides a way to query various transaction records, including mini-settlement."
---
