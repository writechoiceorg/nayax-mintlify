...
metadata:
  og:description: "The getRetailerInfo method allows you to verify the merchant's name and ID. This is useful for confirming that a terminal was configured correctly."
---
