...
metadata:
  og:description: "The doPinpadTransaction method is used in the PinPad flow to continue an ongoing EMV transaction after the initial card capture. This is primarily."
---
