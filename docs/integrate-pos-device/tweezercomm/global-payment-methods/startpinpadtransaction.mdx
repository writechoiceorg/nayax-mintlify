...
metadata:
  og:description: "The startPinpadTransaction method initiates the PinPad process on the payment terminal, instructing it to get ready to receive card information via."
---
