...
title: "showAnimation"
metadata:
  og:description: "Use the showAnimation method to display an animation on the device to indicate either an approved or declined action. This is typically shown."
---
