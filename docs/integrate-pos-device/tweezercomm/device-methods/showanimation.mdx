...
title: "showAnimation"
metadata:
  og:description: "Use the showAnimation the method to display an animation on the device to indicate either an approved or declined action. This is typically shown."
---
