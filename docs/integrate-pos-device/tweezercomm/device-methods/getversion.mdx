...
title: "getVersion"
metadata:
  og:description: "The getVersion method retrieves version information for one or more applications installed on the device, such as agamento, spi, or ashrait."
---
