...
title: "getUserInput"
metadata:
  og:description: "The getUserInput method prompts the user for a numeric or alphanumeric input on the payment terminal. This is typically used to collect an ID, amount."
---
