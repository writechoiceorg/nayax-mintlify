...
metadata:
  og:description: "The getUserSelection method prompts the user to choose an option from a predefined list. This is useful for gathering user input where multiple."
---
