...
title: "setConfig"
metadata:
  og:description: "The setConfig method applies configuration settings to the terminal. These can include settings such as deposit server preferences, enabling the."
---
