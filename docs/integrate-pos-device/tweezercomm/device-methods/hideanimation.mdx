...
title: "hideAnimation"
metadata:
  og:description: "Use the hideAnimation method to cancel or hide a currently displayed animation on the device that was previously initiated using the showAnimation."
---
