...
title: "abortReadCard"
metadata:
  og:description: "Use the abortReadCard method to cancel an ongoing readCard operation. This is helpful when the user wants to stop card reading before it completes."
---
