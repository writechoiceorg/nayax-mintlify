...
metadata:
  og:description: "The sendGeneralEvent method allows the terminal to communicate specific operational events or status updates to the system. This is mainly used."
---
