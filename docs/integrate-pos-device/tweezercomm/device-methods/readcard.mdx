...
title: "readCard"
metadata:
  og:description: "The readCard method reads data from a card using either the magnetic swipe reader (MSR) or the contactless NFC reader. It supports Mifare cards only."
---
