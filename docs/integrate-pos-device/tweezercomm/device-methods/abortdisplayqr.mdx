...
metadata:
  og:description: "Use the abortDisplayQR method to cancel an ongoing QR code display previously initiated with the displayQR method. JSON-RPC 2.0 All methods in."
---
