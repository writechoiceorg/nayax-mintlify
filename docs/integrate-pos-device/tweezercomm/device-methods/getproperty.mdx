...
title: "getProperty"
metadata:
  og:description: "The getProperty method retrieves specific terminal details, such as the terminal serial number (S/N), the DCS hardware serial number, or the Agamento."
---
