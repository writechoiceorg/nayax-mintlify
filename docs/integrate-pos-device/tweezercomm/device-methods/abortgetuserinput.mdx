...
metadata:
  og:description: "The abortGetUserInput method cancels an ongoing user input request initiated by the getUserInput method. This is used when a transaction is canceled."
---
