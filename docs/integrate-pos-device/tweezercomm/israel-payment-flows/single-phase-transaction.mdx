...
metadata:
  og:description: "Unlike the two-phase model, the Single-phase transaction flow for the SHVA payment service processes and authorizes a payment request in a single."
---
