...
title: "TC Service"
metadata:
  og:description: "TC Service allows you to use the Agamento app as a background service. If you want to run your own Android app on the device and perform transactions."
---
