...
If the `statusCode != 0` (indicating an issue) is returned, the system refers to the [Resilience Mechanism](/docs/integrate-pos-device/tweezercomm/deprecated/resilience-flow) to understand how TweezerComm handles errors or retry mechanisms.
</Warning>
