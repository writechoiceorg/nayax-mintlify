...
title: "Get Started"
metadata:
  og:description: "TweezerComm follows the JSON-RPC 2.0 specification to standardize transaction processing between the POS/ECR and Agamento payment application (that."
---
...
<Card
  ...
  href="/docs/integrate-pos-device/tweezercomm/deprecated/tweezercomm-create-payments"
  arrow
/>
</Columns>