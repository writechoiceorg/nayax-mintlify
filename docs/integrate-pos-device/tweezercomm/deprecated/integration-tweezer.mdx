...
* `method`: Specifies the method to be used. See [Payment Services Methods](/docs/integrate-pos-device/tweezercomm/deprecated/transaction-methods) and [Device Methods](/docs/integrate-pos-device/tweezercomm/device-methods/index) for a list and description of available methods.
