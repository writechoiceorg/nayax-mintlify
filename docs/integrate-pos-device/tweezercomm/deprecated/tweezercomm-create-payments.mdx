...
See [Get Started](/docs/integrate-pos-device/tweezercomm/deprecated/integration-tweezer) for more details on how the requests are structured and sent.
</Note>
...
<Card
  icon="link"
  title="Payment Flows"
  href="/docs/integrate-pos-device/tweezercomm/deprecated/tweezercomm-payment-flows"
  arrow
/>
</Columns>