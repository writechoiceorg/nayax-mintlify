...
metadata:
  og:description: "The getInternalStatus method returns the internal status of the AEA. Call this method infrequently to determine the internal state of the engine's."
---
