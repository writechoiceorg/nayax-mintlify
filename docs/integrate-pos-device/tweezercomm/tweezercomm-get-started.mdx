...
* Connect the POS/ECR and Agamento payment application to the same local network
...
* `method`: Specifies the method to be used. See [Global Payment Methods](/docs/transaction-methods), [Israel Payment Methods](/docs/integrate-pos-device/tweezercomm/israel-payment-methods/tweezercomm-israel-payment-methods), and [Device Methods](/docs/integrate-pos-device/tweezercomm/device-methods/index) for a list and description of available methods.
