...
title: "Get Started"
metadata:
  og:description: "The Nayax OEM POS Solution provides a pre-certified EMV module that simplifies the development of card-present kiosks. By integrating the EMV Core."
---
