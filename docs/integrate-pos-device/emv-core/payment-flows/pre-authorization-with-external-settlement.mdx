...
<Frame><img src="/images/docs/pre-authorization-with-external-settlement/payment-authorization.png" alt="Sequence diagram of the payment authorization phase, from the PreAuthorize call through the TransactionComplete event and service delivery" /></Frame>
...
<Frame><img src="/images/docs/pre-authorization-with-external-settlement/external-settlement.png" alt="Sequence diagram of the external settlement flow, from StartAuthentication through the ExternalSettlement response" /></Frame>
...
<Frame><img src="/images/docs/pre-authorization-with-external-settlement/external-cancel.png" alt="Sequence diagram of the external cancel flow, from StartAuthentication through the ExternalCancel response" /></Frame>
