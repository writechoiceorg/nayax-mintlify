...
<Note>
  If you need to cancel a previously pre-authorized transaction, instead of the host application sends a confirm transaction operation to EMV Core, it needs to send a void operation.
</Note>
