...
<Note>
  If you need to cancel a previously pre-authorized transaction, instead of sending a confirm transaction operation to EMV Core, the host application needs to send a void operation.
</Note>
