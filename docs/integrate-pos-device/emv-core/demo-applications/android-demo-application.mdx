...
title: "Android App"
metadata:
  og:description: "The SDK provides a demo application with source code that enables you to test the integration from day one. This demo provides a fully functional."
---
...
Follow these steps to run your first transaction in the demo application:
...
1. Connect your UNO reader to your Android device. If you get a system message saying, “Allow EmvCore Service to access Saturn 8700,” press **OK**.
   ...
   <Warning>
     ...
     * Allow the **Stop optimizing battery usage** option when prompted.
   </Warning>
...
The demo application has four pages. Each page covers a specific area of the integration.
...
<CardGroup cols={2}>
  <Card title="Linux App" href="/docs/integrate-pos-device/emv-core/demo-applications/linux-demo-application">
    Install and run the demo application on a Linux-based device.
  </Card>
  <Card title="EMV Core Overview" href="/docs/integrate-pos-device/emv-core/overview">
    Learn about the EMV Core architecture and integration model.
  </Card>
</CardGroup>