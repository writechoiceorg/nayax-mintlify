...
metadata:
  og:description: "This article provides a centralized jumping-off point for testing the Nayax EMV Core demo applications. Nayax provides a demo app to help you."
---
...
<Columns cols={2}>
  <Card icon="link" title="Android App" href="/docs/integrate-pos-device/emv-core/demo-applications/android-demo-application" />

  <Card icon="link" title="Linux App" href="/docs/integrate-pos-device/emv-core/demo-applications/linux-demo-application" />
</Columns>