...
In single API mode, you select and run commands one at a time from a menu:
...
In auto mode, the application runs a continuous authorize-and-return cycle without manual input:
...
These steps apply to Ubuntu Linux x86\_64 with GCC and automake.
...
<CardGroup cols={2}>
  <Card title="Android App" href="/docs/integrate-pos-device/emv-core/demo-applications/android-demo-application">
    Install and run the demo application on an Android device.
  </Card>
