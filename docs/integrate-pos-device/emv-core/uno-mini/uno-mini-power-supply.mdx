...
- The DC supply voltage must remain within the 5–12 VDC range at all times. The absolute minimum operational voltage is 4.5 V; voltages below this level may cause the device to enter an inconsistent state.
...
| :--- | :--- | :--- |
| **Supply voltage range** | 5–12 VDC | Absolute minimum operational: 4.5 V |
...
The supply must sustain at least 3 W peak load while keeping the output voltage within the 5–12 VDC range under all load conditions.
