...
<Columns cols={3}>
  <Card icon="link" title="Transaction Flows" href="/docs/integrate-pos-device/emv-core/payment-flows/transaction-flow" />

  <Card icon="link" title="EMV Core SDK" href="/docs/integrate-pos-device/emv-core/sdk-methods-functions/emv-core-apis" />
</Columns>
