...
The cashless reader firmware and configuration can be updated:
...
### 2. Reader (POS) Kernel Configuration

The kernel configuration is automatically selected by Nayax Core based on Country, Billing Provider, and Device type.
