...
<CardGroup cols={3}>
  <Card title="Nayax EMV Reader" href="" icon="arrow-up-right">
  ...
  <Card title="Nayax EMV Core" href="" icon="arrow-up-right">
  ...
  <Card title="Host Application" href="" icon="arrow-up-right">
...
<CardGroup cols={3}>
  <Card title="Integration" href="/v1.0/docs/integration" icon="arrow-up-right" />
  <Card title="Transaction Flows" href="/v1.0/docs/transaction-flow" icon="arrow-up-right" />
  <Card title="EMV Core SDK" href="/v1.0/docs/emv-core-apis" icon="arrow-up-right" />
</CardGroup>
