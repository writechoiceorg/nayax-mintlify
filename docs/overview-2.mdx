...
<CardGroup cols={3}>
  <Card title="Integration" href="/docs/integration" icon="arrow-up-right" />
  <Card title="Transaction Flows" href="/docs/transaction-flow" icon="arrow-up-right" />
  <Card title="EMV Core SDK" href="/docs/emv-core-apis" icon="arrow-up-right" />
</CardGroup>
