...
This request targets a dedicated [status endpoint](https://developerhub.nayax.com/reference/post_get-transaction-by-session). It utilizes the `NayaxSessionId `as the primary identifier for the transaction being queried.
