...
<table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Determines the level of detail required to log messages generated by the SDK. You can read more on that in the [Log generation](https://developerhub.nayax.com/docs/log-generation) for more details.
      </td>
    </tr>
  </tbody>
</table>