...
The [Create New Actor ](https://developerhub.nayax.com/reference/create-new-actor)endpoint allows for registering a new operator in the Nayax system. See the example request in the code block below:
