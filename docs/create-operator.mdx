...
The [Create New Actor ](/reference/create-new-actor)endpoint allows for registering a new operator in the Nayax system. See the example request in the code block below:
