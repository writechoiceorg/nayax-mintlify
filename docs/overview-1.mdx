...
1. [Setting up Amazon Queue in AWS](https://developerhub.nayax.com/docs/amazon-queue-setup)
2. [Configuring Nayax Core](https://developerhub.nayax.com/docs/nayax-back-office-setup)
