...
2. The Server sends the request to the integrator using the [DynamicQR GenerateQR](/reference/post_cortina-dynamicqr-generateqr) endpoint.
...
4. The Server sends the request to the integrator using the [DynamicQR Inquiry](/reference/post_cortina-dynamicqr-inquiry) endpoint.
