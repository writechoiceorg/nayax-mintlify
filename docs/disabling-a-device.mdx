...
<HTMLBlock>
  ...
  <body>
    <div class="endpoint_card_container">
      <a class="card" href="https://developerhub.nayax.com/reference/get-device-by-deviceid">
...
You can also use the [Get Device by DeviceID](https://developerhub.nayax.com/reference/get-device-by-deviceid)  endpoint to retrieve the device's information and validate the update's success.
