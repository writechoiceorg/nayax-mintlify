...
You can also use the [Get Device by DeviceID](/reference/get-device-by-deviceid)  endpoint to retrieve the device's information and validate the update's success.
