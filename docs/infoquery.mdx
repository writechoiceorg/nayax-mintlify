...
title: "InfoQuery"
metadata:
  og:description: "Nayax sends an InfoQuery API after a successful StartSession response. Its main purposes are: To retrieve information to be shown on the POS device."
---
...
| `PosDisplay`                 | string  | Custom message to show on the terminal display (semicolon-delimited format). See [PosDisplay Format](/docs/integrate-pos-device/spark/additional-resources/spark-posdisplay-format)  to learn how to format your message. |
