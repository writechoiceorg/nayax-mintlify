...
| `PosDisplay`                 | string  | Custom message to show on the terminal display (semicolon-delimited format). See [PosDisplay Format](/docs/spark-posdisplay-format)  to learn how to format your message. |
