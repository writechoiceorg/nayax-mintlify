...
| `PosDisplay`                 | string  | Custom message to show on the terminal display (semicolon-delimited format). See [PosDisplay Format](https://developerhub.nayax.com/docs/spark-posdisplay-format)  to learn how to format your message. |
