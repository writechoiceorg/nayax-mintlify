...
Now that the eCom SDK is integrated into your Android application, you can start processing payments through it. See the [Front-End Integration](https://developerhub.nayax.com/docs/front-end-sdk) guide for more details on how this works.
