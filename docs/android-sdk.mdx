...
Now the eCom SDK is integrated into your Android application, and you can start creating payments through it. See the [Front-End Integration](doc:front-end-sdk) guide for more details on how this works.

## See Also

<Cards columns={2}>
  <NayaxCard title="iOS SDK" href="/v1.0/docs/ios-sdk" />
