...
Use the [Create Pick List](/reference/generate-pick-list) endpoint to create a list for a specified machine based on its current stock levels and sales data.
