...
title: "Settlement"
metadata:
  og:description: "Use the Settlement endpoint to finalize an approved transaction. After the session ends and the total amount is known, the integrator sends the."
---

Use the `Settlement` endpoint to finalize an approved transaction. After the session ends and the total amount is known, you send the final amount along with optional e-receipt information.
...
| `AuthCode`                | String | Authorization code returned by the payment provider.                                                                                    |
