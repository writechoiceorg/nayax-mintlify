...
title: 多选自动售货机
metadata:
  og:description: 通过多次贩售流程，您的机器可以在一笔交易中发放多个产品（在 4.0.25.9 及以上版本中最多 20 个，在此之后可达 40 个）。
---

借助**多商品自动售货**流程，您的机器可以在单次交易中售出多种商品（4.0.25.9 及更高版本最多可售出 20 种，4.0.25.9 及更高版本最多可售出 40 种），并在 SDK 中为每种商品提供差异化标识。顾客首先选择所有所需商品，然后出示支付卡。授权后，自动售货机将售出所选商品，交易会话结算完毕，并显示相应的提示信息。
...
<Frame>
  <img src="/images/docs/marshall-multi-vend-with-pre-sel/image1.png" />
</Frame>
...
2. 消费者从自动售货机中选择所需的商品。这些商品将被添加到名为“会话”的列表中：
...
13. SDK 报告“供应商成功”：
    ...
    <Note>
      **注意：**如果出现部分出货的情况（即并非所有选定的商品都实际售出），您可以在回复“true”之前创建一个仅包含实际售出商品的新列表：
    </Note>

    <Frame>
      <img src="/images/docs/marshall-multi-vend-with-pre-sel/image2.jpg" />
    </Frame>
