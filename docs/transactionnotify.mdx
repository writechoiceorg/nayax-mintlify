...
metadata:
  og:description: "Use the TransactionNotify endpoint to notify the integrator about the final details of a charging session, including charger availability, amount."
---

Use the `TransactionNotify `endpoint to notify the integrator about the final details of a charging session, including charger availability, amount, and display information. This request is made after the session has been prepared and the charger is ready for use.
