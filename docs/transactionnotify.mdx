...
Use the `TransactionNotify` endpoint to notify the integrator about the final details of a charging session, including charger availability, amount, and display information. Send this request after you prepare the session and the charger is ready for use.
