...
[Get Actor Details by ActorID ](/reference/get-actor-by-actorid)retrieves comprehensive information about a specific actor. This endpoint provides detailed attributes, including profile information and associated configurations, for the actor identified by the provided ActorID.
...
The [Update Operator/Sub-Operator](/reference/update-actor) endpoint allows to edit the inforamtion of the specified operator.
