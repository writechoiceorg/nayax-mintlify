...
title: "Edit Products"
metadata:
  og:description: "This page presents how to edit a product in the Product Map using the Lynx API. In the step-by-step guide below, you'll use the following endpoints."
---
