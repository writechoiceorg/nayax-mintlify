...
<EndpointCard
  ...
  href="/reference/lynx/machine-products/update-machine-product"
  method="put"
/>
</Columns>
...
Use the [Update a Machine Product](/reference/lynx/machine-products/update-machine-product) endpoint to update the product details, such as changing the `CashPrice`. Keep other values unchanged, including the `MDBCode`.
