...
<Columns cols={2}>
  ...
  <Card title="Get Card by the Card's Display Number" href="https://developerhub.nayax.com/reference/lynx/cards/get-cards-by-display-number" />

  <Card title="Get Prepaid Card" href="/reference/get-prepaid-card" />

  <Card title="Get the Credit from a Card" href="/reference/get-card-credit" />

  <Card title="Get Card's Revalue" href="/reference/get-card-revalue" />
</Columns>
