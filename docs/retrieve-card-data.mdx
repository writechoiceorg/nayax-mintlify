...
<Columns cols={2}>
  <Card title="Get Cards" href="/v1.0/reference/get-cards" />

  <Card title="Get Card by the Card's Display Number" href="https://developerhub.nayax.com/reference/get-cards-by-display-number" />

  <Card title="Get Prepaid Card" href="/v1.0/reference/get-prepaid-card" />

  <Card title="Get the Credit from a Card" href="/v1.0/reference/get-card-credit" />

  <Card title="Get Card's Revalue" href="/v1.0/reference/get-card-revalue" />
</Columns>
...
Refer to the [Security & Token](https://developerhub.nayax.com/docs/security) page of this documentation to learn how to access your tokens, and how to use it to authenticate your API requests properly.
</Warning>
