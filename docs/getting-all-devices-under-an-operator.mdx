...
Using the [Get Device by DeviceID](/reference/get-device-by-deviceid) endpoint, providing it with the `deviceID` as a path parameter, you can retrieve that device's details. See an example request and response  in the code block below:
