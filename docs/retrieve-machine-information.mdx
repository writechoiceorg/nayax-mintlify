...
Using the [Get Specific Machine Basic Info](/reference/get-machine-basic-info) you can get the details of a machine with a specific `MachineID`. See an example request in the code block below:
...
Using the [Get Specific Machine Basic Info by VPOS](/reference/get-machine-basic-info-by-vpos) endpoint, you can retrieve the details of a machine associated with a specific `VPOSSerial`. See an example request in the code block below:
