...
<Columns cols={2}>
  <Card title="Get Specific Machine Basic Info by MachineID" href="/reference/lynx/machines/get-specific-machine-basic-info">
    GET
  </Card>

  <Card title="Get Specific Machine Basic Info by Device" href="/reference/lynx/machines/get-specific-machine-basic-info-by-device">
    GET
  </Card>

  <Card title="Get Specific Machine Basic Info by VPOS" href="/reference/lynx/machines/get-specific-machine-basic-info-by-vpos">
    GET
  </Card>

  <Card title="Get All Machine Basic Info" href="/reference/lynx/machines/get-all-machine-basic-info">
    GET
  </Card>
</Columns>
