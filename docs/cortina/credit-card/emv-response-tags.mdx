...
metadata:
  og:description: "When processing EMV contact credit card transactions, including the EMV response tags in your authorization sale response is critical to ensure."
---
