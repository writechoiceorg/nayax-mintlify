...
title: "Authorization"
metadata:
  og:description: "Cortina SQR uses the Authorization command to notify the integrator about the result of a card tap in order to initiate the authorization process."
---
