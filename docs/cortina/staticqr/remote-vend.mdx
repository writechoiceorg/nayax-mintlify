...
metadata:
  og:description: "Remote Vend allows the integrator to initiate a transaction with the selected product using the Start call. The selected product can be sent as a."
---
