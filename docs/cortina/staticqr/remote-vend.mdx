...
The selected product can be sent as a product code for MDB or Marshall machines, or a specific pulse line ID for Pulse machines.

<Note>
This functionality is currently supported only with `VPOST\ONYX` device.
</Note>
