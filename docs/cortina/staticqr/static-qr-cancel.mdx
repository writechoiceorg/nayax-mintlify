...
title: "Cancel"
metadata:
  og:description: "Cortina SQR uses the Cancel command to notify the integrator in order to initiate the cancellation process with the Cortina payment provider."
---
