...
<u>For Pulse array machines</u> (any Pulse configuration except Pulse Line), the `"code"` numbering starts from 0.<br />For example, in case of:
...
The `Start` Response that Nayax's servers would send to the payment method.<br />The payload should look as follows:
