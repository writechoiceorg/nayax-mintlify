...
For Pulse array machines (any Pulse configuration except Pulse Line), the `"code"` numbering starts from 0:

- **"Ultimate"** product → `"Code": 0`
- **"Superior"** product → `"Code": 1`
- **"Regular"** product → `"Code": 2`
