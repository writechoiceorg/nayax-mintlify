...
In case the product fails to be dispensed to the consumer, the Nayax Engine uses the [StaticQR Cancel](/reference/cortina/staticqr/cortina-staticqr-cancel) endpoint to void the payment request.
</Warning>
...
In case the product fails to be dispensed to the consumer, the Nayax Engine uses the [StaticQR Cancel](/reference/cortina/staticqr/cortina-staticqr-cancel) endpoint to cancel the Pre Authorization and the transaction.
</Warning>