---
title: "DynamicQR Decline Reasons"
metadata:
  og:description: "When a transaction is declined, the Cortina API returns a specific decline reason code that explains why the payment was not approved."
---
...
The following decline reason codes are used when processing DynamicQR transactions:
...
| 4        | The cardholder exceeded the transaction amount limit                    |
| 5        | Suspected fraud                                                         |
...
| 30       | The machine is not responding                                           |
...
| 993      | Pending (relevant only for the Inquiry command)                         |
