...
title: "Void"
metadata:
  og:description: "Cortina DQR uses the Voidcommand to notify the integrator in order to initiate the cancelation process with the Cortina payment provider whenever on."
---
