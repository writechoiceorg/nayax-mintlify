...
Cortina DQR uses the `GenerateQR` command to notify the integrator about the consumer's product selection in order for you to send the QR generation details.\
