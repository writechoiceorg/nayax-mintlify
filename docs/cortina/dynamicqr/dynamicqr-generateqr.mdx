...
title: "GenerateQR"
metadata:
  og:description: "Cortina DQR uses the GenerateQR command to notify the integrator about the consumer's product selection in order to send the QR generation."
---
