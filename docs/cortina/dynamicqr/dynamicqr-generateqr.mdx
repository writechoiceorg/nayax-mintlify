...
title: "GenerateQR"
metadata:
  og:description: "Cortina DQR uses the GenerateQR command to notify the integrator about the consumer's product selection in order for him to send the QR generation."
---
