...
title: "Inquiry"
metadata:
  og:description: "Cortina DQR uses the Inquiry to inquire the approval status of a Transaction ID. This call will include the transaction’s final amount and the."
---
...
An “Approved” response to this call will usually attempt to vend/release the product.\
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        ...
        <ul>
          ...
          <li>**Note:** Currencies with no decimal places are still represented as a double (e.g., 234 JPY = `234.0`).</li>
        </ul>
      </td>
    </tr>
...
In case of "pending" response, it will lead to Nayax's servers to keep polling until either a final response has been received ("Approved"/"Declined") or it reaches the limit as configured in Nayax Core.
