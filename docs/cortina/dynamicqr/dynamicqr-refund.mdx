...
title: "Refund"
metadata:
  og:description: "Cortina DQR uses the Refund command to notify the integrator about the refund request in order to initiate the refund process with the Cortina."
---
