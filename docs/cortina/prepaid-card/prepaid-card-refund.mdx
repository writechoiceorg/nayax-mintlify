...
title: "Refund"
metadata:
  og:description: "Cortina Prepaid uses the Refund command to notify the integrator about the refund request in order to initiate the authorization process with the."
---
