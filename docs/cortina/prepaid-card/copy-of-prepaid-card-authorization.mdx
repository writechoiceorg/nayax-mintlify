...
title: "Authorization"
metadata:
  og:description: "Cortina Prepaid uses the Authorization command to notify about the result of a card tap to initiate the authorization process with the Cortina."
---
      ...
      <tr>
        ...
        <td style={{ textAlign: "left" }}>
          ...
          <ul>
            ...
            <li>Note: Currencies with no decimal places (e.g., JPY) are still represented as a double, e.g., 234 JPY = `234.0`.</li>
          </ul>
        </td>
      </tr>
