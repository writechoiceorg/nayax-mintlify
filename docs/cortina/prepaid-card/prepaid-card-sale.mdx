...
title: "Sale"
metadata:
  og:description: "Cortina Prepaid uses the Sale command to notify the integrator about the result of a card tap after a product has been selected in order to initiate."
---
