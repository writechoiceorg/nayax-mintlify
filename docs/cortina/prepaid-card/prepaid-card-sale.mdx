...
title: "Sale"
metadata:
  og:description: "Cortina Prepaid uses the Salecommand to notify the integrator about the result of a card tap after a product has been selected in order to initiate."
---
      ...
      <tr>
        ...
        <td style={{ textAlign: "left" }}>
          ...
          <ul>
            ...
            <li>Currencies with no decimal places (e.g., JPY) are still represented as a double (e.g., `234.0`).</li>
          </ul>
        </td>
      </tr>
