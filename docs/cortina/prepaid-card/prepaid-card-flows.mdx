...
| **Timeout / Void** | N/A | If no Sale Response is received within the timeout period, or a `992` response code is received- the [Prepaid Void](/reference/cortina/cortina-prepaid/cortina-prepaid-void) endpoint is triggered. |
