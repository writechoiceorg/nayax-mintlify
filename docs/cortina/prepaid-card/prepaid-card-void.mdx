...
title: "Void"
metadata:
  og:description: "Cortina Prepaid uses the Voidcommand to notify the integrator in order to initiate the cancellation process with the Cortina payment provider."
---
