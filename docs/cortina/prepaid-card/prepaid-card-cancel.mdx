...
title: "Cancel"
metadata:
  og:description: "Cortina Prepaid uses the Cancelcommand to notify the integrator in order to initiate the cancelation process with the Cortina payment provider."
---
