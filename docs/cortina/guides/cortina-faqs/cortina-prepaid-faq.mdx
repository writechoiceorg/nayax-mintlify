...
<Accordion title="Answer" icon="info-circle">
  ...
  * It must be included and encrypted in the `StartSession` response body. (For full details, please refer to the [Start Session authentication process](/docs/cortina-auth#/)).
