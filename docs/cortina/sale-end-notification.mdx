...
metadata:
  og:description: "Cortina uses the SaleEndNotification command to notify the integrator about the completion of the transaction request with the Cortina payment."
---
...
<table align={["left","left","left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The original amount requested in /Authorization.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        Contact Nayax TPOC in order to define.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Was there a gateway timeout (valid in response)
      </td>
    </tr>
...
The table below describes all the parameters of the response:
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        The AES key will be the last (right most) 256 bits (or 32 chars) of the Secret Token that matches the TokenID provided in the request.
