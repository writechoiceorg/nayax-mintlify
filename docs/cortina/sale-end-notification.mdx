...
metadata:
  og:description: "Cortina uses the SaleEndNotificationcommand to notify the integrator about the completion of the transaction request with the Cortina payment."
---
