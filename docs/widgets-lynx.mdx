...
<Note>
  Every widget has its own unique identifier (`widget_type_id`), filters, and other configuration options. See a list of all [Widgets ID List](/docs/available-widgets).
</Note>
