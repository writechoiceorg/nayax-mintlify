...
title: "StartSession"
metadata:
  og:description: "This is the initial API call sent by Nayax. It initiates the transaction session by authenticating both parties and generating a SparkTransactionId."
---

This is the initial API call sent by Nayax. It initiates the transaction session by authenticating both parties and generating a `SparkTransactionId`, which all subsequent calls echo throughout the transaction's lifecycle.
