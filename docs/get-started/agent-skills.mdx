...
The examples below install `nayax-lynx-inventory`. To install a different skill, swap in its name from the table above (and, for Smithery, its own skill page). Install the skill with the tool that matches your setup:
...
```
  ...
  <Tab title="Smithery">
    Install the skill from its
    [Smithery page](https://smithery.ai/skills/anayse/lynx-inventory) with the
    `skills` CLI:

```bash
npx -y skills add https://smithery.ai/skills/anayse/lynx-inventory
```
  </Tab>
</Tabs>
