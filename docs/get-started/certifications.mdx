...
SOC 2 (System and Organization Controls 2) is a reporting framework
...
auditor, covering the Q4 2024 audit period. The full report is
confidential: Nayax shares it with clients and prospective clients only
after they sign a non-disclosure agreement (NDA).
