...
<CardGroup cols={3}>
  <Card title="Integration" href="/v1.0/docs/spark-integration" icon="arrow-up-right" />
  ...
  <Card title="Webhook Callbacks" href="/v1.0/docs/webhook-callbacks" icon="arrow-up-right" />
</CardGroup>