...
<Columns cols={3}>
  <Card title="Integration" href="https://developerhub.nayax.com/docs/spark-integration" />

  <Card title="Network Requirements" href="https://developerhub.nayax.com/docs/spark-network-requirement" />

  <Card title="Security & Authentication" href="https://developerhub.nayax.com/docs/security-authentication" />

  <Card title="Payment Flows" href="https://developerhub.nayax.com/docs/transaction-flows-spark" />

  <Card title="Spark API Reference" href="https://developerhub.nayax.com/reference/overview-spark-api#" />

  <Card title="Webhook Callbacks" href="https://developerhub.nayax.com/docs/webhook-callbacks" />

  <Card title="Additional Resources" href="https://developerhub.nayax.com/docs/additional-resources" />

  <Card title="Sample Codes" href="https://developerhub.nayax.com/docs/spark-authentication-code-sample" />
</Columns>