...
<Columns cols={3}>
  <Card title="Integration" href="/docs/spark-integration" />

  <Card title="Network Requirements" href="/docs/spark-network-requirement" />

  <Card title="Security & Authentication" href="/docs/security-authentication" />

  <Card title="Payment Flows" href="/docs/transaction-flows-spark" />

  <Card title="Spark API Reference" href="/reference/overview-spark-api#" />

  <Card title="Webhook Callbacks" href="/docs/webhook-callbacks" />

  <Card title="Additional Resources" href="/docs/additional-resources" />

  <Card title="Sample Codes" href="/docs/spark-authentication-code-sample" />
</Columns>