...
* `method`: Specifies the method to be used. See [Global Payment Methods](https://developerhub.nayax.com/docs/transaction-methods), [Israel Payment Methods](https://developerhub.nayax.com/docs/tweezercomm-israel-payment-methods), and [Device Methods](https://developerhub.nayax.com/docs/device-methods) for a list and description of available methods.
...
* `params`:  This is an array divided into two parts.
  * The first specifies the payment service to be used:
    * `engine` for global transactions. See [Global Payment Flows](https://developerhub.nayax.com/docs/payment-flows-copy-1) for more details.
    * `ashrait` for Israel transactions. See [Israel Payment Flows](https://developerhub.nayax.com/docs/tweezercomm-israel-payment-flows) for more details.
