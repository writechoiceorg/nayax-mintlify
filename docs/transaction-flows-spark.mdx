...
<CardGroup cols={3}>
  <Card title="Device Start" href="/v1.0/docs/spark-device-start" icon="arrow-up-right" />
  <Card title="Remote Start" href="/v1.0/docs/spark-remote-start" icon="arrow-up-right" />
  <Card title="Device Stop" href="/v1.0/docs/spark-device-stop" icon="arrow-up-right" />
</CardGroup>