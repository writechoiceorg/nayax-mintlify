  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Information regarding how to generate the TranIDCipher (via encrypting the token alongside the Random Number and the customer's Transaction ID can be reviewed under [Start Session authentication process](https://developerhub.nayax.com/docs/cortina-auth#/)
      </td>
    </tr>
