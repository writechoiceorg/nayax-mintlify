...
Here is an example of a JSON request for the POST [ `/initialize` ](/reference/post_initialize) endpoint, demonstrating a simple sale transaction.
...
For more details on each parameter, see the [ `/initialize` ](/reference/post_initialize) endpoint API reference page.
