...
As explained in [Payment Flows](doc:payment-flows), the Marshall SDK supports various payment flows. The pages below explain how to implement each in your VMC using the **C SDK**.

<CardGroup cols={3}>
  <Card title="Single Session" href="/v1.0/docs/single-session" icon="arrow-up-right" />
  <Card title="Multi-Session" href="/v1.0/docs/multi-session" icon="arrow-up-right" />
  <Card title="Multi-Vend" href="/v1.0/docs/multi-vend" icon="arrow-up-right" />
  <Card title="Always-Idle" href="/v1.0/docs/always-idle" icon="arrow-up-right" />
</CardGroup>

## See Also

<CardGroup cols={2}>
  <Card title="C SDK Integration" href="/v1.0/docs/spark-security-authentication" icon="arrow-up-right" />
  <Card title="Methods & Functions" href="/v1.0/docs/transaction-flows-spark" icon="arrow-up-right" />
</CardGroup>