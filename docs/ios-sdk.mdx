...
Now the eCom SDK is integrated into your iOS application, and you can start creating payments through it. Refer to the [Front-End Integration](https://developerhub.nayax.com/docs/front-end-sdk) guide for more information on how this works.
