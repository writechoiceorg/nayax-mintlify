...
4. Select the operator to display all tabs and details.
   ...
   <Image align="center" className="border" border={true} src="https://files.readme.io/788f6d744b6ffb6c32943f2394faa33825be62233a36a4f0674705b46c76aae4-image.png" />
...
6. Setup General and Alert via SQS:
   ...
   <Image align="center" className="border" border={true} src="https://files.readme.io/4bc91e397cb5831bbdc8799c4ef31395169f545add332f7d482f10b8bbada416-image.png" />
...
8. Click the **Save Information** button to apply the changes.
   ...
   <Frame>![](/images/docs/set-up-events-delivery/images1.png)</Frame>
