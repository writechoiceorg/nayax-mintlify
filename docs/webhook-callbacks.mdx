...
<CardGroup cols={3}>
  ...
  <Card title="TimeoutCallback" href="/v1.0/docs/timeoutcallback" icon="arrow-up-right" />
  <Card title="DeclineCallback" href="/v1.0/docs/declinecallback" icon="arrow-up-right" />
</CardGroup>
