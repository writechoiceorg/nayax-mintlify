...
| `CardUid`              | String  | No       | Unique identifier of the card, if available. See a more detailed explanation on the [SMC Support](https://developerhub.nayax.com/docs/smc-support)  page. |
