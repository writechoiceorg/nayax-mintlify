  ...
  const cards = [
    {
      ...
      title: "外部预付卡",
      description: "通过服务器对服务器授权，在 Nayax 设备上接受闭环卡。",
      link: "/docs/zh/cortina/prepaid-card/copy-of-prepaid-card-authorization",
    },
    {
      icon: <StaticQRIcon />,
      title: "静态二维码",
      description: "通过简单的静态二维码集成，接受数字钱包或忠诚度应用。",
      link: "/docs/zh/cortina/staticqr/static-qr-start",
    },
    {
      icon: <DynamicQRIcon />,
      title: "动态二维码",
      description: "为大批量数字钱包支付实现安全的动态二维码扫描。",
      link: "/docs/zh/cortina/dynamicqr/dynamicqr-decline-reasons",
    },
    {
      icon: <EMVIntegrationIcon />,
      title: "EMV 集成",
      description: "通过您首选的收单机构或网关直接集成 EMV 卡支付。",
      link: "/docs/zh/cortina/credit-card/credit-card-decline-reasons",
    },
  ];
    ...
    <section className="py-16 px-6 md:px-12 lg:px-20 bg-white dark:bg-[#1B1B1B]">
      <div className="max-w-[1400px] mx-auto">
        ...
        <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-5xl">
          通过 Cortina 集成，在任何 Nayax POS 上接受客户应用、忠诚度卡或闭环支付方式。{" "}
          <a href="/docs/zh/cortina/cortina-integration-process" className="text-blue-600 dark:text-blue-400 hover:underline">
            了解更多 →
          </a>
        </p>
