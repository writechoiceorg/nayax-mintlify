  ...
  const cards = [
    {
      ...
      title: "无人值守设备",
      subtitle: "Marshall",
      description: "通过物理连接方式，使用 VPOS Touch 或 Onyx 连接无人值守设备。",
      link: "/docs/zh/integrate-pos-device/marshall/get-started/marshall-integration-process",
    },
    {
      icon: <FuelPumpIcon />,
      title: "燃油与加油站",
      subtitle: "Marshall Pro",
      description: "专为燃油加注机设计的集成方案，提供经过认证的分步流程。",
      link: "/docs/zh/integrate-pos-device/marshall-pro/getting-started/index",
    },
    {
      icon: <AttendedDeviceIcon />,
      title: "有人值守零售",
      subtitle: "TweezerComm",
      description: "将有人值守支付设备（Nova 系列）直接与您的销售点系统集成。",
      link: "/docs/zh/integrate-pos-device/tweezercomm/overview-tweezer",
    },
    {
      icon: <EmbeddedDeviceIcon />,
      title: "嵌入式设备",
      subtitle: "EMV Core",
      description: "使用嵌入式 Nayax 支付设备（Uno 系列）连接无人值守设备。",
      link: "/docs/zh/integrate-pos-device/emv-core/get-started/emv-core-integration-process",
    },
    {
      icon: <RemoteDeviceIcon />,
      title: "远程集成",
      subtitle: "Spark",
      description: "通过服务器对服务器连接，将您的平台与 Nayax 设备进行远程集成。",
      link: "/docs/zh/integrate-pos-device/spark/spark-integration-process",
    },
    {
      icon: <AuthToolIcon />,
      title: "认证工具",
      subtitle: "Spark",
      description: "在浏览器中加密或解密 StartAuthentication 和 StartSession 密文，并生成 Header 签名。",
      link: "/docs/zh/integrate-pos-device/spark/security-authentication/spark-auth-tool",
    },
    {
      icon: <EVChargerIcon />,
      title: "EV 充电桩",
      subtitle: "OCPI",
      description: "使用开放充电点协议（OCPI）集成您的 EV 平台。",
      link: "#ocpi",
      comingSoon: true,
    },
  ];
    ...
    <section className="py-16 px-6 md:px-12 lg:px-20 bg-white dark:bg-[#1B1B1B]">
      <div className="max-w-[1400px] mx-auto">
        ...
        <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-4xl">
          将 Nayax POS 与您的自动售货机、自助终端、EV 充电桩或任何实体应用连接。
        </p>
