  ...
  const cards = [
    {
      ...
      description: "通过 Amazon SQS 实时接收交易报告，或通过 SFTP 或电子邮件定期接收。",
      link: "/docs/zh/manage-data-operations/amazon-sqs/overview",
    },
    {
      icon: <OperationsAPIIcon />,
      title: "运营与管理",
      subtitle: "Lynx API",
      description: "将 Nayax Core 平台集成到您的环境中，以管理库存和设备。",
      link: "docs/zh/manage-data-operations/lynx-api/lynx-overview",
    },
  ];
