...
<CardGroup cols={3}>
  <Card title="Device Start" href="/docs/spark-device-start" icon="arrow-up-right" />
  <Card title="Remote Start" href="/docs/spark-remote-start" icon="arrow-up-right" />
  <Card title="Device Stop" href="/docs/spark-device-stop" icon="arrow-up-right" />
</CardGroup>