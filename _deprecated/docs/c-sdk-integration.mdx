...
<CardGroup cols={3}>
  <Card title="Single Session" href="/docs/single-session" icon="arrow-up-right" />
  <Card title="Multi-Session" href="/docs/multi-session" icon="arrow-up-right" />
  <Card title="Multi-Vend" href="/docs/multi-vend" icon="arrow-up-right" />
  <Card title="Always-Idle" href="/docs/always-idle" icon="arrow-up-right" />
</CardGroup>

## See Also

<CardGroup cols={2}>
  <Card title="C SDK Integration" href="/docs/spark-security-authentication" icon="arrow-up-right" />
  <Card title="Methods & Functions" href="/docs/transaction-flows-spark" icon="arrow-up-right" />
</CardGroup>