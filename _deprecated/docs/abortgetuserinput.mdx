...
The `abortGetUserInput `method cancels an ongoing user input request initiated by the [`getUserInput `](doc:getuserinput)method. This is used when a transaction is canceled or when input is no longer needed.
